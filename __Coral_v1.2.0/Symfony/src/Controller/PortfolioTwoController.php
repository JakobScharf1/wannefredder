...
final class PortfolioTwoController extends AbstractController
{
    ...
    #[Route('/portfolio-detail-two/{slug?}', name: 'app_portfolio_detail_two')]
    public function details(string $slug = null): Response
    {
        ...
        return $this->render('portfolio-detail-two.html.twig', [
