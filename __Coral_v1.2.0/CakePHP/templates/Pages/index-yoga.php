<?php
$this->assign('title', 'Index-Yoga Page');
?>
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="title-heading">
                    ...
                    <div class="mt-4 pt-2">
                        <a href="<?= $this->Url->build('/services'); ?>" class="btn btn-outline-primary">Get Started <i class="mdi mdi-arrow-right"></i></a>
                    </div>
                </div>
            </div><!--end col-->
                        ...
                        <div class="col-12">
                            <div class="tiny-single-item-no-nav">
                                <div class="tiny-slide">
                                    <img src="<?= $this->Url->build('/assets/images/hero1.png'); ?>" class="img-fluid" alt="">
                                </div>
                                <div class="tiny-slide">
                                    <img src="<?= $this->Url->build('/assets/images/hero2.png'); ?>" class="img-fluid" alt="">
                                </div>
                                <div class="tiny-slide">
                                    <img src="<?= $this->Url->build('/assets/images/hero3.png'); ?>" class="img-fluid" alt="">
                                </div>
                                <div class="tiny-slide">
                                    <img src="<?= $this->Url->build('/assets/images/hero4.png'); ?>" class="img-fluid" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="position-absolute top-0 start-0 z-n1">
                        <img src="<?= $this->Url->build('/assets/images/hero/yoga-hero.png'); ?>" class="img-fluid" alt="">
                    </div>
                </div>
            </div><!--end col-->
        </div><!--end row-->
...
<section class="section">
            ...
            <div class="col-md-6">
                <div class="position-relative">
                    <div class="me-lg-5 me-4">
                        <img src="<?= $this->Url->build('/assets/images/about/yoga3.jpg'); ?>" class="img-fluid rounded border border-4 shadow" alt="">
                    </div>
                    
                    <div class="position-absolute top-50 end-0">
                        <img src="<?= $this->Url->build('/assets/images/about/yoga2.jpg'); ?>" class="img-fluid avatar avatar-xl-large w-auto rounded border border-4 shadow" alt="">
            ...
            <div class="col-md-6 mt-4 mt-md-0 pt-2 pt-md-0">
                <div class="section-title ms-lg-4">
                    ...
                    <div class="row">
                        ...
                        <!-- templates/element/Home/index-yoga/counter4.php -->
                        <?= $this->element('Home/index-yoga/counter4'); ?>
    ...
    <div class="container mt-100 mt-60">
        ...
        <div class="row g-4">
            ...
            <!-- templates/element/Home/index-yoga/services8.php -->
            <?= $this->element('Home/index-yoga/services8'); ?>
            ...
            <div class="col-lg-4 col-md-5 col-10">
                <div class="position-relative z-1 p-4 rounded shadow bg-white">
                    <div class="tiny-single-item">
                        ...
                        <!-- templates/element/Home/index-yoga/review4.php -->
                        <?= $this->element('Home/index-yoga/review4'); ?>
...
<section class="section" id="schedule">
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <ul class="nav nav-pills nav-justified flex-column mb-0 sticky-bar" id="pills-tab" role="tablist">
                    ...
                    <!-- templates/element/Home/index-yoga/nav.php -->
                    <?= $this->element('Home/index-yoga/nav'); ?>
                        ...
                        <div class="table-responsive bg-white shadow rounded">
                            <table class="table mb-0 table-center">
                                <tbody>
                                    ...
                                    <!-- templates/element/Home/index-yoga/monday.php -->
                                    <?= $this->element('Home/index-yoga/monday'); ?>
                        ...
                        <div class="table-responsive bg-white shadow rounded">
                            <table class="table mb-0 table-center">
                                <tbody>
                                    ...
                                    <!-- templates/element/Home/index-yoga/tuesday.php -->
                                    <?= $this->element('Home/index-yoga/tuesday'); ?>
                        ...
                        <div class="table-responsive bg-white shadow rounded">
                            <table class="table mb-0 table-center">
                                <tbody>
                                    ...
                                    <!-- templates/element/Home/index-yoga/wednesday.php -->
                                    <?= $this->element('Home/index-yoga/wednesday'); ?>
                        ...
                        <div class="table-responsive bg-white shadow rounded">
                            <table class="table mb-0 table-center">
                                <tbody>
                                    ...
                                    <!-- templates/element/Home/index-yoga/thursday.php -->
                                    <?= $this->element('Home/index-yoga/thursday'); ?>
                        ...
                        <div class="table-responsive bg-white shadow rounded">
                            <table class="table mb-0 table-center">
                                <tbody>
                                    ...
                                    <!-- templates/element/Home/index-yoga/friday.php -->
                                    <?= $this->element('Home/index-yoga/friday'); ?>
                        ...
                        <div class="table-responsive bg-white shadow rounded">
                            <table class="table mb-0 table-center">
                                <tbody>
                                    ...
                                    <!-- templates/element/Home/index-yoga/saturday.php -->
                                    <?= $this->element('Home/index-yoga/saturday'); ?>
    ...
    <div class="container mt-100 mt-60">
        ...
        <div class="row g-4">
            ...
            <!-- templates/element/Home/index-yoga/coaches.php -->
            <?= $this->element('Home/index-yoga/coaches'); ?>
    ...
    <div class="container mt-100 mt-60 overflow-hidden">
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-6">
                <div class="position-relative">
                    <img src="<?= $this->Url->build('/assets/images/faqs.png'); ?>" class="img-fluid" alt="">
