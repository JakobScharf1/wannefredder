<?php
$this->assign('title', 'Comingsoon Page');
?>

<section class="bg-home d-flex align-items-center" style="background: url('<?= $this->Url->build('/assets/images/hero/special.jpg'); ?>') center;">
