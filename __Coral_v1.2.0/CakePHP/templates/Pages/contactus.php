<?php
$this->assign('title', 'Contactus Page');
?>
...
<section class="section pb-0">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
                <img src="<?= $this->Url->build('/assets/images/contact.png'); ?>" class="img-fluid d-block mx-auto" alt="">
            </div>
            <div class="col-md-6">
    ...
    <div class="container mt-100 mt-60">
        <div class="row">
            ...
            <!-- templates/element/contactus/contacts.php -->
            <?= $this->element('contactus/contacts'); ?>
