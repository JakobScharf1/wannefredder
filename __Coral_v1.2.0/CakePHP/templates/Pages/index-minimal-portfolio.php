<?php
$this->assign('title', 'Index-Minimal-Portfolio Page');
?>

<!-- Include Navbar -->
<?= $this->element('navbar6') ?>
                ...
                <div class="row align-items-center g-4">
                    ...
                    <div class="col-lg-5 col-md-6 order-1 order-md-2">
                        <div class="position-relative">
                            <img src="<?= $this->Url->build('/assets/images/logo-icon.png'); ?>" class="img-fluid opacity-25" alt="">
        ...
        <section class="section pt-1">
            <div class="container">
                <div class="row g-0" id="grid">
                    ...
                    <!-- templates/element/Home/index-minimal-portfolio/portfolio2.php -->
                    <?= $this->element('Home/index-minimal-portfolio/portfolio2'); ?>
