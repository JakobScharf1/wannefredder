            ...
            <div class="col-12 p-0">
                <div class="d-flex flex-column min-vh-100 justify-content-center px-md-5 py-5 px-4">
                    <div class="text-center">
                        <a href="<?= $this->Url->build('/'); ?>"><img src="<?= $this->Url->build('/assets/images/logo-icon-64.png'); ?>" alt=""></a>
                    </div>
                    <div class="title-heading text-center my-auto">
                        <img src="<?= $this->Url->build('/assets/images/error.png'); ?>" class="img-fluid" alt="">
                        ...
                        <div class="mt-4">
                            <a href="<?= $this->Url->build('/'); ?>" class="btn btn-primary">Back to Home</a>
                        </div>
                    </div>
                    <div class="text-center">
