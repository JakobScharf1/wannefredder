<?php
$this->assign('title', 'Service-Detail Page');
?>
        ...
        <div class="row g-4">
            <div class="col-lg-8 col-md-7">
                <div class="card position-relative overflow-hidden">
                    <div class="card-img">
                        <img src="<?= $this->Url->build('/assets/images/blog/8.jpg'); ?>" class="img-fluid rounded" alt="">
            ...
            <div class="col-lg-4 col-md-5 col-12">
                <div class="sticky-bar">
                    <div>
                        ...
                        <!-- templates/element/Pages/service-detail/services10.php -->
                        <?= $this->element('Pages/service-detail/services10'); ?>
