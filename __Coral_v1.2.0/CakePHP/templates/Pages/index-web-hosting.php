<?php
$this->assign('title', 'Index-Web-Hosting Page');
?>

<!-- Include Navbar -->
<?= $this->element('navbar7') ?>

<!-- Start -->
<section class="bg-half-170 bg-primary bg-gradient">
    <div class="bg-overlay bg-transparent" style="background: url('<?= $this->Url->build('/assets/images/hero/bg-hosting.png'); ?>') center center;"></div>
    <div class="container mt-5">
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-6">
                <div class="title-heading">
                    ...
                    <div class="subscribe-form mt-4 py-2">
                        <form class="mx-auto" action="<?= $this->Url->build('/'); ?>">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="ms-lg-4">
                    <img src="<?= $this->Url->build('/assets/images/hero/hosting-hero.png'); ?>" class="img-fluid" alt="">
                </div>
            </div><!--end col-->
        </div><!--end row-->
    </div><!--end container-->
...
<section class="section">
            ...
            <div class="col-lg-12">
                <div class="features-absolute">
                    <div class="row row-cols-lg-5 row-cols-md-3 row-cols-lg-2 row-cols-lg-1 g-4">
                        ...
                        <!-- templates/element/Home/index-web-hosting/hosting.php -->
                        <?= $this->element('Home/index-web-hosting/hosting'); ?>
    ...
    <div class="container mt-100 mt-60">
        <div class="row align-items-center">
            <div class="col-lg-5 col-md-6">
                <img src="<?= $this->Url->build('/assets/images/about.png'); ?>" class="img-fluid" alt="">
            </div><!--end col-->
    ...
    <div class="container-fluid position-relative pt-5 mt-100 mt-60">
        ...
        <div class="container mt-5">
            ...
            <div class="row">
                ...
                <!-- templates/element/Home/index-web-hosting/counter3.php -->
                <?= $this->element('Home/index-web-hosting/counter3'); ?>
    ...
    <div class="container-fluid mt-100 mt-60">
        <div class="rounded-3 position-relative overflow-hidden py-5 px-4" style="background: url('<?= $this->Url->build('/assets/images/hero/pages.jpg'); ?>') fixed;">
