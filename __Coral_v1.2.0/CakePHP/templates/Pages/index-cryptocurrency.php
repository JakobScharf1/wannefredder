<?php
$this->assign('title', 'Index-Cryptocurrency Page');
?>
...
<!-- Hero Start -->
<section class="bg-half-260 position-relative overflow-hidden pb-5" style="background: url('<?= $this->Url->build('/assets/images/hero/bg-crypto.jpg'); ?>') top no-repeat;">
    ...
    <div class="container position-relative">
        <div class="row justify-content-center">
            <div class="col-lg-12 text-center">
                <div class="title-heading position-relative z-1 margin-top-100">
                    ...
                    <div class="mt-4 pt-2">
                        <a href="<?= $this->Url->build('/services'); ?>" class="btn btn-lg btn-pills btn-primary m-1">Join Now</a>
        ...
        <div class="position-absolute top-0 end-0 translate-middle-y">
            <img src="<?= $this->Url->build('/assets/images/bitcoin.png'); ?>" class="avatar avatar-large mover" alt="">
        </div>

        <div class="position-absolute bottom-0 start-0">
            <img src="<?= $this->Url->build('/assets/images/ethereum.png'); ?>" class="avatar avatar-large mover" alt="">
        </div>
    </div><!--end container-->
        ...
        <div class="row">
            <div class="col-12">
                <div class="tiny-three-item-icon">
                    ...
                    <!-- templates/element/Home/index-cryptocurrency/coin-slider.php -->
                    <?= $this->element('Home/index-cryptocurrency/coin-slider'); ?>
...
<section class="section">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-5 col-md-6">
                <img src="<?= $this->Url->build('/assets/images/bitcoin.svg'); ?>" class="img-fluid" alt="">
            </div><!--end col-->
                ...
                <div class="table-responsive shadow rounded">
                    <table class="table mb-0 table-center bg-white">
                        ...
                        <tbody>
                            ...
                            <!-- templates/element/Home/index-cryptocurrency/table.php -->
                            <?= $this->element('Home/index-cryptocurrency/table'); ?>
    ...
    <div class="container mt-100 mt-60">
        ...
        <div class="row justify-content-center g-4">
            ...
            <!-- templates/element/Home/index-cryptocurrency/trader.php -->
            <?= $this->element('Home/index-cryptocurrency/trader'); ?>
        ...
        <div class="row">
            <div class="col-12 mt-4">
                <div class="tiny-three-item">
                    ...
                    <!-- templates/element/Home/index-saas/review2.php -->
                    <?= $this->element('Home/index-saas/review2'); ?>
    ...
    <div class="container mt-100 mt-60">
        <div class="row align-items-center">
            <div class="col-lg-5 col-md-5 col-12">
                <img src="<?= $this->Url->build('/assets/images/01.png'); ?>" class="img-fluid mx-auto d-block" alt="">
            </div><!--end col-->
                ...
                <div class="section-title">
                    ...
                    <div class="my-4">
                        <a href="javascript:void(0)">
                            <img src="<?= $this->Url->build('/assets/images/app.png'); ?>" class="me-2" height="50" alt="">
                        </a>

                        <a href="javascript:void(0)">
                            <img src="<?= $this->Url->build('/assets/images/playstore.png'); ?>" height="50" alt="">
                        </a>
                    </div>
