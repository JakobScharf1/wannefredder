<?php
$this->assign('title', 'Index-Consulting Page');
?>
...
<section class="bg-half-170 d-table w-100">
    <div class="bg-overlay bg-soft-primary" style="background: url('<?= $this->Url->build('/assets/images/hero/bg-consulting.png'); ?>') bottom no-repeat;"></div>
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-7 col-md-6">
                <div class="title-heading">
                    ...
                    <div class="mt-4 pt-2">
                        <a href="<?= $this->Url->build('/services'); ?>" class="btn btn-primary m-1">Our Services</a>
...
<section class="section">
    <div class="container">
        ...
        <div class="row align-items-center g-4">
            ...
            <!-- templates/element/Home/index-consulting/services3.php -->
            <?= $this->element('Home/index-consulting/services3'); ?>
    ...
    <div class="container mt-100 mt-60 overflow-hidden">
        ...
        <!-- templates/element/Home/index-consulting/digital.php -->
        <?= $this->element('Home/index-consulting/digital'); ?>
