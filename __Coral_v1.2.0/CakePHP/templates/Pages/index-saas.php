<?php
$this->assign('title', 'Index-Saas Page');
?>
...
<!-- Hero Start -->
<section class="bg-hero d-table w-100 bg-dark overflow-hidden" style="background: url('<?= $this->Url->build('/assets/images/hero/bg.png'); ?>') center center;">
                ...
                <div class="tilt-3d margin-absolute">
                    <div class="tilt-3d-trigger">
                        ...
                        <div class="tilt-3d-image position-relative">
                            <img src="<?= $this->Url->build('/assets/images/hero/hero.png'); ?>" class="img-fluid rounded-4 border-primary" alt="">
                        </div>
                    </div>
                </div>
            </div><!--end col-->
...
<section class="section overflow-hidden">
    ...
    <div class="container mt-100 mt-60">
        ...
        <!-- templates/element/Home/index-saas/boost.php -->
        <?= $this->element('Home/index-saas/boost'); ?>

    </div><!--end container-->

    <div class="container mt-100 mt-60">
        
        <!-- templates/element/Home/index-saas/optimize.php -->
        <?= $this->element('Home/index-saas/optimize'); ?>
