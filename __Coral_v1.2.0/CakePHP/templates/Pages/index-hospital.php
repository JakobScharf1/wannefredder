<?php
$this->assign('title', 'Index-Hospital Page');
?>
    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <div class="swiper-slide d-flex align-items-center overflow-hidden">
                <div class="slide-inner slide-bg-image d-flex align-items-center" style="background: center center;" data-background="<?= $this->Url->build('/assets/images/hero/1.jpg'); ?>">
                        ...
                        <div class="row justify-content-center mt-5">
                            <div class="col-12">
                                <div class="title-heading">
                                    ...
                                    <div class="mt-4 pt-2">
                                        <a href="javascript:void(0)" class="btn btn-primary">Make Appointment</a>
                                    </div>
                                </div>
                            </div><!--end col-->
                        </div><!--end row-->
            ...
            <div class="swiper-slide d-flex align-items-center overflow-hidden">
                <div class="slide-inner slide-bg-image d-flex align-items-center" style="background: center center;" data-background="<?= $this->Url->build('/assets/images/hero/2.jpg'); ?>">
                    <div class="bg-overlay"></div>
                    <div class="container">
                        <div class="row justify-content-center mt-5">
                            <div class="col-12">
                                <div class="title-heading">
                                    ...
                                    <div class="mt-4 pt-2">
                                        <a href="javascript:void(0)" class="btn btn-primary">Find a Doctor</a>
                                    </div>
                                </div>
                            </div><!--end col-->
                        </div><!--end row-->
            ...
            <div class="swiper-slide d-flex align-items-center overflow-hidden">
                <div class="slide-inner slide-bg-image d-flex align-items-center" style="background: center center;" data-background="<?= $this->Url->build('/assets/images/hero/3.jpg'); ?>">
                    <div class="bg-overlay"></div>
                    <div class="container">
                        <div class="row justify-content-center mt-5">
                            <div class="col-12">
...
<section class="section">
        ...
        <div class="row align-items-center">
            <div class="col-lg-5 col-md-6 mb-5 mb-md-0 pb-5 pb-md-4">
                <div class="position-relative">
                    <div class="me-lg-5 me-4">
                        <img src="<?= $this->Url->build('/assets/images/about/hos1.jpg'); ?>" class="img-fluid rounded border border-4 shadow" alt="">
                    </div>
                    
                    <div class="position-absolute top-50 end-0">
                        <img src="<?= $this->Url->build('/assets/images/about/hos2.jpg'); ?>" class="img-fluid h-auto rounded border border-4 shadow" width="250px" alt="">
            ...
            <div class="col-lg-7 col-md-6 mt-4 mt-md-0 pt-4 pt-md-0">
                <div class="section-title ms-lg-5">
                    ...
                    <div class="mt-4">
                        <a href="javascript:void(0)" class="btn btn-soft-primary">Make Appointment</a>
                    </div>
                </div>
            </div><!--end col-->
        </div><!--end row-->
    ...
    <div class="container mt-100 mt-60">
        ...
        <div class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1 g-4 mt-2">
            
            <!-- templates/element/Home/index-hospital/services6.php -->
            <?= $this->element('Home/index-hospital/services6'); ?>

        </div><!--end row-->

        <div class="row justify-content-center mt-4">
            <div class="col-12 text-center">
                <a href="<?= $this->Url->build('/services'); ?>" class="btn btn-link primary fs-6">See More Services <i class="mdi mdi-arrow-right"></i></a>
            </div><!--end col-->
        </div><!--end row-->
    </div><!--end container-->
</section><!--end section-->
                ...
                <div class="table-responsive rounded">
                    <table class="table table-center table-bordered bg-white mb-0">
                        ...
                        <tbody>
                            ...
                            <!-- templates/element/Home/index-hospital/availability.php -->
                            <?= $this->element('Home/index-hospital/availability'); ?>
...
<!-- Start CTA -->
<section class="cta-video-section position-relative" style="background: url('<?= $this->Url->build('/assets/images/hero/auth.jpg'); ?>') center fixed;">
    <div class="bg-overlay"></div>
    <div class="container">
...
<section class="section">
    <div class="container">
        ...
        <div class="row align-items-center g-4">
            ...
            <!-- templates/element/Home/index-hospital/team.php -->
            <?= $this->element('Home/index-hospital/team'); ?>
