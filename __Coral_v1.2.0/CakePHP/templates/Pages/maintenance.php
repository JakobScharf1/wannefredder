<?php
$this->assign('title', 'Maintenance Page');
?>     
<!-- Start -->
<section class="bg-home d-flex align-items-center overflow-hidden" style="background: url('<?= $this->Url->build('/assets/images/hero/special.jpg'); ?>') center;">
            ...
            <div class="col-12 p-0">
                <div class="d-flex flex-column min-vh-100 justify-content-center p-md-5">
                    <div class="text-center">
                        <a href="<?= $this->Url->build('/'); ?>"><img src="<?= $this->Url->build('/assets/images/logo-icon-80-white.png'); ?>" alt=""></a>
                    </div>
