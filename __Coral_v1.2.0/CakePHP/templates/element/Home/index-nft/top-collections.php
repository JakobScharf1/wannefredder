        ...
        <div class="nft-item nft-collection rounded shadow position-relative overflow-hidden">
            ...
            <div class="position-absolute bottom-0 start-0 end-0 bg-white p-4">
                <div class="position-absolute top-0 start-50 translate-middle">
                    <img src="<?= $this->Url->build('/' . h($item['img1'])) ?>" class="avatar avatar-small rounded-pill img-thumbnail shadow-md" alt="">
                </div>

                <div class="mt-4 text-center">
                    <a href="<?= $this->Url->build('/nft-explore'); ?>" class="text-dark link-title h5"><?= h($item['title']) ?></a>
                    
                    <p class="text-muted mb-0 small"><?= h($item['name']) ?></p>
                </div>
            </div>
        </div>
    </div>
