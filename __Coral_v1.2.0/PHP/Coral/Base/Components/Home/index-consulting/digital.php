<div class="row g-4 align-items-center">
    <div class="col-lg-6 col-md-6 order-1 order-md-2">
        <div class="position-relative">
            <img src="<?php echo $static_url; ?>/images/presentation-3-87.svg" class="img-fluid" alt="">
    ...
    <div class="col-lg-6 col-md-6 order-md-1 order-2">
        <div class="section-title me-lg-5">
            ...
            <div class="mt-4">
                <a href="aboutus.php" class="btn btn-primary">About Us <i class="mdi mdi-arrow-right align-middle"></i></a>
            </div>
        </div>
    </div><!--end col-->
</div><!--end row-->