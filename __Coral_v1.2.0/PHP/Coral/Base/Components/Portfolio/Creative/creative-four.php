    ...
    <div class="col-lg-3 col-md-6">
        <div class="portfolio creative rounded shadow position-relative overflow-hidden">
            ...
            <div class="content position-absolute bottom-0 start-0 end-0 m-4">
                <a href="portfolio-detail.php?title=<?php echo urlencode(str_replace(' ', '-', strtolower($item['title']))); ?>" class="text-white fs-5 fw-medium link-title"><?php echo $item['title']; ?></a>
