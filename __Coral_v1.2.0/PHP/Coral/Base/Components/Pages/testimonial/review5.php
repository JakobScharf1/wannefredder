            ...
            <div class="<?php echo $item['style']; ?>">
                <div class="position-relative overflow-hidden z-1 bg-white rounded shadow p-4">
                    <div class="d-flex align-items-center justify-content-between">
                        <h6 class="mb-0"><?php echo $item['title1']; ?></h6>
                    ...
                    <p class="text-muted fst-italic mt-2">" <?php echo $item['desc']; ?> "</p>

                    <div class="d-flex align-items-center">
                        <img src="<?php echo $static_url, $item['img']; ?>" class="avatar avatar-small rounded-pill shadow" alt="">
                        <div class="ms-2">
                            <h6 class="text-dark small mb-0"><?php echo $item['name']; ?></h6>
                            <small class="text-muted d-block"><?php echo $item['title']; ?></small>
                        </div>
                    </div>
