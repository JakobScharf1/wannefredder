        ...
        <div class="position-relative rounded shadow overflow-hidden">
            ...
            <div class="position-relative">
                <div class="position-absolute top-0 start-50 translate-middle">
                    <img src="<?php echo $static_url, $item['img']; ?>" class="avatar avatar-small rounded-pill shadow-sm img-thumbnail bg-light" alt="">
                </div>
                <div class="content text-center p-4">
                    <div class="mt-4">
                        <a href="creator-profile.php" class="text-dark h6 link-title mb-0"><?php echo $item['name']; ?></a>
                    </div>
                    <small class="text-muted"><?php echo $item['title']; ?></small>

                    <div class="mt-3">
                        <a href="javascript:void(0)" class="btn btn-sm btn-soft-primary"><?php echo $item['btn']; ?></a>
                    </div>
                </div>
            </div>
        </div>
