    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <div class="swiper-slide d-flex align-items-center overflow-hidden">
                <div class="slide-inner slide-bg-image d-flex align-items-center" style="background: center center;" data-background="<?php echo $static_url; ?>/images/hero/1.jpg">
            ...
            <div class="swiper-slide d-flex align-items-center overflow-hidden">
                <div class="slide-inner slide-bg-image d-flex align-items-center" style="background: center center;" data-background="<?php echo $static_url; ?>/images/hero/2.jpg">
                    <div class="bg-overlay"></div>
                    <div class="container">
                        <div class="row justify-content-center mt-5">
                            <div class="col-12">
            ...
            <div class="swiper-slide d-flex align-items-center overflow-hidden">
                <div class="slide-inner slide-bg-image d-flex align-items-center" style="background: center center;" data-background="<?php echo $static_url; ?>/images/hero/3.jpg">
                    <div class="bg-overlay"></div>
                    <div class="container">
                        <div class="row justify-content-center mt-5">
                            <div class="col-12">
...
<section class="section">
            ...
            <div class="col-lg-5 col-md-6 mb-5 mb-md-0 pb-5 pb-md-4">
                <div class="position-relative">
                    <div class="me-lg-5 me-4">
                        <img src="<?php echo $static_url; ?>/images/about/hos1.jpg" class="img-fluid rounded border border-4 shadow" alt="">
                    </div>
                    
                    <div class="position-absolute top-50 end-0">
                        <img src="<?php echo $static_url; ?>/images/about/hos2.jpg" class="img-fluid h-auto rounded border border-4 shadow" width="250px" alt="">
    ...
    <div class="container mt-100 mt-60">
        ...
        <div class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1 g-4 mt-2">
            ...
            <!-- services6 code  -->
            <?php
                include "$base_dir/Components/Home/index-hospital/services6.php";
            ?>
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-12 text-center">
                <a href="services.php" class="btn btn-link primary fs-6">See More Services <i class="mdi mdi-arrow-right"></i></a>
            </div><!--end col-->
        </div><!--end row-->
    </div><!--end container-->
</section><!--end section-->
                ...
                <div class="table-responsive rounded">
                    <table class="table table-center table-bordered bg-white mb-0">
                        ...
                        <tbody>
                            ...
                            <!-- availability code  -->
                            <?php
                                include "$base_dir/Components/Home/index-hospital/availability.php";
                            ?>
...
<!-- Start CTA -->
<section class="cta-video-section position-relative" style="background: url('<?php echo $static_url; ?>/images/hero/auth.jpg') center fixed;">
    <div class="bg-overlay"></div>
    <div class="container">
...
<section class="section">
    <div class="container">
        ...
        <div class="row align-items-center g-4">
            ...
            <!-- team code  -->
            <?php
                include "$base_dir/Components/Home/index-hospital/team.php";
            ?>
