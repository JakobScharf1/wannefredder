        ...
        <div class="row align-items-center">
            <div class="col-lg-7 col-md-6">
                <div class="title-heading">
                    ...
                    <div class="mt-4 pt-2">
                        <a href="nft-explore.php" class="btn btn-primary me-1"><i class="mdi mdi-camera-outline align-middle"></i> Explore</a>
            ...
            <div class="col-lg-5 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                <div class="position-relative">
                    <div class="tiny-single-item">
                        ...
                        <!-- nft-slider code  -->
                        <?php
                            include "$base_dir/Components/Home/index-nft/nft-slider.php";
                        ?>
...
<section class="section pt-0">
    <div class="container">
        <div class="row align-items-end mb-4 pb-2">
            ...
            <div class="col-md-4">
                <div class="text-end d-md-block d-none">
                    <a href="nft-explore.php" class="btn btn-link primary text-dark">See More <i class="mdi mdi-arrow-right"></i></a>
                </div>
            </div><!--end slide-->
        </div><!--end row-->
        ...
        <div class="row g-4">
            ...
            <!-- product code  -->
            <?php
                include "$base_dir/Components/Home/index-nft/product.php";
            ?>
    ...
    <div class="container mt-100 mt-60">
        ...
        <div class="row g-4">
            ...
            <!-- services7 code  -->
            <?php
                include "$base_dir/Components/Home/index-nft/services7.php";
            ?>
        ...
        <div class="row g-4">
            <div class="col-md-6">
                <div class="card p-4 rounded-md shadow bg-white">
                    ...
                    <div class="mt-3">
                        <a href="aboutus.php" class="btn btn-link primary text-dark">Read More <i class="mdi mdi-arrow-right"></i></a>
                    </div>
                    <div class="py-4"></div>
                    <div class="position-absolute bottom-0 end-0">
                        <img src="<?php echo $static_url; ?>/images/community.png" class="avatar avatar-medium opacity-25" alt="">
                    </div>
                </div>
            </div><!--end col-->
            ...
            <div class="col-md-6">
                <div class="card p-4 rounded-md shadow bg-white">
                    ...
                    <div class="py-4"></div>
                    <div class="position-absolute bottom-0 end-0">
                        <img src="<?php echo $static_url; ?>/images/united.png" class="avatar avatar-medium opacity-25" alt="">
                    </div>
                </div>
            </div><!--end col-->
        </div><!--end row-->
...
<section class="section">
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <!-- top-collections code  -->
            <?php
                include "$base_dir/Components/Home/index-nft/top-collections.php";
            ?>
