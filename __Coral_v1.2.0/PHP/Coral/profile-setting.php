        ...
        <div class="position-middle-bottom">
            <nav aria-label="breadcrumb" class="d-block">
                <ul class="breadcrumb breadcrumb-muted mb-0 p-0">
                    ...
                    <li class="breadcrumb-item"><a href="creators.php">Creators</a></li>
                    <li class="breadcrumb-item"><a href="creator-profile.php">@StreetBoy</a></li>
            ...
            <div class="col-lg-4 col-md-5 col-12">
                <div class="profile-pic">
                    ...
                    <div class="position-relative d-inline-block">
                        <img id="output" src="<?php echo $static_url; ?>/images/team/1.jpg" class="avatar avatar-medium img-thumbnail rounded-pill shadow-sm" id="profile-image" alt="">
