...
<section class="section pb-0">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
                <img src="<?php echo $static_url; ?>/images/contact.png" class="img-fluid d-block mx-auto" alt="">
            </div>
            <div class="col-md-6">
                <div class="p-4 rounded shadow bg-white ms-lg-5">
                    <h4>Get in touch !</h4>
                    <form class="mt-4" method="post" name="myForm">
    ...
    <div class="container mt-100 mt-60">
        <div class="row">
            ...
            <!-- contacts code  -->
            <?php
                include "$base_dir/Components/contactus/contacts.php";
            ?>
