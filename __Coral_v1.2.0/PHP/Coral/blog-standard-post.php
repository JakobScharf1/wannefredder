                    ...
                    <h5 class="heading fw-semibold mb-0 sub-heading text-white title-dark mt-4">
                        <?php 
                            if (!empty($article['title'])) {
                                ...
                                echo 'Utilizing mobile technology in the field'; 
                            }
                        ?>
                    </h5>
        ...
        <div class="row g-4">
            <div class="col-lg-8 col-md-7">
                <div class="card border-0 shadow rounded overflow-hidden">
                    <img src="<?php echo !empty($article['img']) ? $static_url . $article['img'] : $static_url . '/images/blog/1.jpg'; ?>" class="img-fluid" alt="">
