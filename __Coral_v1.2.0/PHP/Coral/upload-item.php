                ...
                <div class="rounded shadow overflow-hidden sticky-bar">
                    ...
                    <div class="position-relative">
                        <div class="position-absolute top-0 start-50 translate-middle">
                            <img src="<?php echo $static_url; ?>/images/team/1.jpg" class="avatar avatar-small rounded-pill shadow-sm img-thumbnail bg-light" alt="">
                        </div>
                        <div class="content text-center p-4">
                            <div class="mt-4">
                                ...
                                <ul class="list-unstyled mb-0 mt-3" id="navmenu-nav">
                                    <li class="px-0">
                                        <a href="creator-profile.php" class="d-flex align-items-center text-dark">
                                    ...
                                    <li class="px-0 mt-2">
                                        <a href="profile-setting.php" class="d-flex align-items-center text-dark">
                                    ...
                                    <li class="px-0 mt-2">
                                        <a href="lock-screen.php" class="d-flex align-items-center text-dark">
