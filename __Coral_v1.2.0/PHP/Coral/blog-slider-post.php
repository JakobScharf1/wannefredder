                        ...
                        <div id="carouselExampleInterval" class="carousel slide mb-4" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="<?php echo $static_url; ?>/images/blog/1.jpg" class="d-block w-100 rounded shadow" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo $static_url; ?>/images/blog/2.jpg" class="d-block w-100 rounded shadow" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo $static_url; ?>/images/blog/3.jpg" class="d-block w-100 rounded shadow" alt="...">
                                </div>
                            </div>
