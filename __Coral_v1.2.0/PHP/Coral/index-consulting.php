...
<section class="bg-half-170 d-table w-100">
    <div class="bg-overlay bg-soft-primary" style="background: url('<?php echo $static_url; ?>/images/hero/bg-consulting.png') bottom no-repeat;"></div>
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-7 col-md-6">
                <div class="title-heading">
                    ...
                    <div class="mt-4 pt-2">
                        <a href="services.php" class="btn btn-primary m-1">Our Services</a>
...
<section class="section">
    <div class="container">
        ...
        <div class="row align-items-center g-4">
            ...
            <!-- services3 code  -->
            <?php
                include "$base_dir/Components/Home/index-consulting/services3.php";
            ?>
    ...
    <div class="container mt-100 mt-60 overflow-hidden">
        ...
        <!-- digital code  -->
        <?php
            include "$base_dir/Components/Home/index-consulting/digital.php";
        ?>
