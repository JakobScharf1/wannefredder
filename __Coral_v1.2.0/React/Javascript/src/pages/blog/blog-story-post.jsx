...
export default function BlogStoryPost() {
  return (
    <>
        <Navlight/>
                ...
                <div className="row mt-5 justify-content-center">
                    <div className="col-12">
                        <div className="title-heading text-center">
                            ...
                            <h5 className="heading fw-semibold mb-0 sub-heading text-white title-dark mt-4">The Dragon Of The Old Tower</h5>
                ...
                <div className="position-middle-bottom">
                    <nav aria-label="breadcrumb" className="d-block">
                        <ul className="breadcrumb breadcrumb-muted mb-0 p-0">
                            ...
                            <li className="breadcrumb-item active" aria-current="page">The Dragon Of The Old Tower</li>
                        </ul>
                    </nav>
                </div>
            </div>
                    ...
                    <div className="col-lg-8 col-md-7">
                        <div className="card border-0 shadow rounded overflow-hidden">
                            <div className="card-body">
                                <div className="blog-story py-5 mb-4 text-center bg-soft-primary rounded shadow">
                                    <p className="fst-italic mb-0 fs-4">“ People think focus means saying yes to the thing you’ve got to focus on. But that’s not what it means at all building into the identity and culture. ”</p>
                                </div>
                                <BlogDesc/>
                            </div>
                        </div>
