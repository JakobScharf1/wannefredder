...
import hero from '../../assets/images/logo-icon.png'
                    ...
                    <div className="row align-items-center g-4">
                        ...
                        <div className="col-lg-5 col-md-6 order-1 order-md-2">
                            <div className="position-relative">
                                <img src={hero} className="img-fluid opacity-25" alt=""/>
                                <div className="position-absolute top-50 start-50 translate-middle">
                                    <Link to="#" onClick={() => setIsOpen(!isOpen)} className="avatar avatar-md-md rounded-pill shadow bg-primary d-flex justify-content-center align-items-center lightbox">
                                ...
                                <div className="portfolio masonry position-relative overflow-hidden">
                                    ...
                                    <div className="content">
                                        <div className="title-body p-3 position-absolute start-0 end-0 m-4">
                                            <a href="" className="link-title text-white fs-5 fw-medium">Artboard Studio</a>
                    ...
                    <div className="row">
                        <div className="col">
                            <div className="mt-4 text-center">
                                <Link to="#" className="btn btn-primary">See more works <i className="mdi mdi-arrow-right"></i></Link>
                            </div>
                        </div>
                    </div>
                </div>
