...
import image2 from '../../assets/images/united.png'
...
export default function NftCta() {
  return (
        <section className="cta-video-section position-relative overflow-hidden" style={{backgroundImage:`url(${bg})`, backgroundAttachment:'fixed'}}>
            ...
            <div className="container">
                ...
                <div className="row g-4">
                    {data.map((item:Cta,index:number)=>( 
                        <div className="col-md-6" key={index}>
                            <div className="card p-4 rounded-md shadow bg-white">
                                ...
                                <div className="mt-3">
                                    <Link to="/aboutus" className="btn btn-link primary text-dark">Read More <i className="mdi mdi-arrow-right"></i></Link>
                                </div>
                                <div className="py-4"></div>
                                <div className="position-absolute bottom-0 end-0">
                                    <img src={item.image} className="avatar avatar-medium opacity-25" alt=""/>
                                </div>
                            </div>
                        </div>
                    ))}
