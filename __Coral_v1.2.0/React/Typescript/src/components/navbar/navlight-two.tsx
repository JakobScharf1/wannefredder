...
export default function NavlightTwo() {
  ...
  return (
    <>
        <header id="topnav" className={`defaultscroll sticky tagline-height ${scrolling ? 'nav-sticky' : ''}`}>
                ...
                <ul className="buy-button list-inline mb-0">
                    ...
                    <li className="list-inline-item ps-1 mb-0">
                        <Link to="#" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">
                            <div className="btn btn-sm btn-icon btn-pills btn-danger"><FiSettings className="fea icon-sm"/></div>
                        </Link>
                    </li>

                    <li className="list-inline-item ps-1 mb-0">
                        <Link to="#" className="btn btn-sm btn-danger">Join Now</Link>
                    </li>
                </ul>
