        ...
        <section className="section">
            <div className="container">
                <div className="row g-4">
                    {wallet.map((item:WalletData,index:number)=>( 
                            ...
                            <div className="wallet position-relative overflow-hidden rounded shadow">
                                ...
                                <div className="position-relative">
                                    ...
                                    <div className="content text-center p-4">
                                        ...
                                        <p className="text-muted mt-3 mb-0">Learn about how to get the wallet and much more clicking <Link to="#" className="text-primary">here <i className="mdi mdi-arrow-right"></i></Link></p>
                                    </div>
                                </div>
                            </div>
                        </div>
