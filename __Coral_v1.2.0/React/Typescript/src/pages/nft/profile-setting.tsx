                                    ...
                                    <form className="profile-edit">
                                        <div className="row">
                                            <div className="col-12 mb-4">
                                                ...
                                                <input name="name" id="first" type="text" className="form-control" value="streetboyyy"/>
                                            </div>
        
                                            <div className="col-12 mb-4">
                                                <label className="form-label h6">URL</label>
                                                <div className="form-icon">
                                                    <input name="url" id="Coral-url" type="url" className="form-control" value="https://Coral.exe/streetboyyy"/>
                                                </div>
                                            </div>
                                            ...
                                            <div className="col-12 mb-4">
                                                ...
                                                <div className="form-icon">
                                                    <input name="url" id="web-url" type="url" className="form-control" value="https://streetboyyy.com/"/>
                                                </div>
                                            </div>
            
                                            <div className="col-12 mb-4">
                                                <label className="form-label h6">Email</label>
                                                <input name="email" id="email" type="email" className="form-control" value="streetboyyy@example.com"/>
                                            </div>
                                        </div>
