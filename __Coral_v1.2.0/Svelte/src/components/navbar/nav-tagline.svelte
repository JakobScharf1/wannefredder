...
<header id="topnav" class={`defaultscroll sticky tagline-height ${scroll ? 'nav-sticky' : ''}`}>
    <div class="container">
        <Link class="logo" to="/">
        ...
        <ul class="buy-button list-inline mb-0">
            ...
            <li class="list-inline-item ps-1 mb-0">
                <a href="#!" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" aria-label="link">
