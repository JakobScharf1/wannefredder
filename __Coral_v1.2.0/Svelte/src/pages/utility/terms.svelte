        ...
        <div class="row mt-5 justify-content-center">
            <div class="col-12">
                <div class="title-heading text-center">
                    <h5 class="heading fw-semibold mb-0 sub-heading text-white title-dark">Terms & Conditions</h5>
                </div>
            </div>
        </div>
...
<section class="section">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-9">
                <div class="card bg-light shadow border-0 rounded">
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            ...
                            <a href="#!" class="btn btn-outline-primary mt-2">Decline</a>
                        </div>
                    </div>
                </div>
            </div>
