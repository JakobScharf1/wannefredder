...
// @ts-nocheck
    ...
    import Navdark from "../../components/navbar/navdark.svelte";
...
<div id="boxed-layput" style="background: url({bg});">
    <div class="boxed">
        <Navdark/>
                    ...
                    <div class="col-lg-5 col-md-6 order-1 order-md-2">
                        <div class="position-relative">
                            ...
                            <div class="position-absolute top-50 start-50 translate-middle">
                                <a href="#!" data-type="youtube" data-id="yba7hPeTSjk" aria-label="link" class="avatar avatar-md-md rounded-pill shadow bg-primary d-flex justify-content-center align-items-center lightbox">
                            ...
                            <div class="portfolio masonry position-relative overflow-hidden">
                                ...
                                <div class="content">
                                    <div class="title-body p-3 position-absolute start-0 end-0 m-4">
                                        <a href="#!" class="link-title text-white fs-5 fw-medium">Artboard Studio</a>
                                        <p class="text-white-50 mb-0">Custom Branding</p>
                                    </div>

                                    <div class="p-3 position-absolute top-0 end-0 m-4">
                                        <a href={item.image} class="btn btn-sm btn-icon btn-pills btn-primary lightbox" aria-label="link"><i data-feather="camera" class="fea icon-sm"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
