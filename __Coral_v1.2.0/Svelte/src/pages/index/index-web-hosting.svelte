<script>
    ...
    import HostingNav from "../../components/navbar/hosting-nav.svelte";
    ...
    import { counterData, webServices } from "../../data/data";
...
<section class="bg-half-170 bg-primary bg-gradient">
    <div class="bg-overlay bg-transparent" style="background: url({bg}) center center;"></div>
...
<section class="section">
            ...
            <div class="col-lg-12">
                <div class="features-absolute">
                    <div class="row row-cols-lg-5 row-cols-md-3 row-cols-lg-2 row-cols-lg-1 g-4">
                        {#each webServices as item}
                            <div class="col">
                                <div class="features rounded shadow p-4 bg-primary bg-gradient">
                                    <img src={item.image} class="avatar avatar-md-sm" alt="">
    
                                    <div class="mt-3">
                                        <a href="#!" class="text-white fw-semibold">{item.title}</a>
                                        <small class="text-white-50 d-block mt-1">Starting $2.99/month</small>
                                    </div>
                                </div>
                            </div>
                        {/each}
    ...
    <div class="container-fluid position-relative pt-5 mt-100 mt-60">
        <div class="bg-overlay opacity-25" style="background: url({map}) center center;"></div>
        <div class="container mt-5">
            <div class="row justify-content-center">
                <div class="col">
                ...
                {#each counterData.slice(0,3) as item}
                    <div class="col-4 py-3">
                        <div class="counter-box text-center">
                            <h1 class="mb-0 fw-semibold"><Countup value={item.value}/>{item.symbol}</h1>
    ...
    <div class="container-fluid mt-100 mt-60">
        <div class="rounded-3 position-relative overflow-hidden py-5 px-4" style="background: url({cta}) fixed;">
