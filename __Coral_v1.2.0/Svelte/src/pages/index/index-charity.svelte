...
// @ts-nocheck
     ...
     import Navlight from "../../components/navbar/navlight.svelte";
    import { causeData } from '../../data/data';
    import CtaTwo from '../../components/cta/cta-two.svelte';
    import BlogOne from '../../components/blog-one.svelte';
    import TeamOne from '../../components/team/team-one.svelte';
    import FeatureOne from '../../components/feature/feature-one.svelte';
...
<section class="bg-half-260" id="home" style="background: url('{currentImage}') center;">
        ...
        <div class="row align-items-center mt-5">
            <div class="col-lg-7 col-md-8 order-md-1 order-2">
                <div class="title-heading">
                    ...
                    <div class="mt-4 pt-2">
                        <a href="#!" class="btn btn-primary me-1">Enroll Today</a>
                        <a href="#!" class="btn btn-soft-primary">Make a Donation</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-5 col-md-4 order-md-2 order-1">
                <div class="d-md-flex justify-content-center">
                    <a href="#!" data-type="youtube" aria-label="link" data-id="yba7hPeTSjk" class="avatar avatar-md-md rounded-pill shadow bg-white d-flex justify-content-center align-items-center lightbox">
                    ...
                    <div class="p-4 rounded shadow position-relative bg-white">
                        ...
                        <form class="mt-4">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        <label class="form-label fw-semibold" for="select">I Want to Donate for</label>
                                ...
                                <div class="col-12">
                                    <label class="form-label fw-semibold" for="da">How much do you want to donate ?</label>
                                    <div class="mb-3">
                                ...
                                <div class="col-12">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="flexCheckDefault">I agree to the <a href="#!" class="text-primary">Terms and Conditions</a>.</label>
                                    </div>
                                </div>                                    
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="position-relative rounded bg-white shadow overflow-hidden">
                        ...
                        <div class="content p-4">
                            <h5><a href="#!" class="text-dark link-title">{item.title}</a></h5>
