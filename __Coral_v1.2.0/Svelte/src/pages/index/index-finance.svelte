...
// @ts-nocheck
    ...
    import NavBg from "../../components/navbar/nav-bg.svelte";
    ...
    let randomImage ;
    let backgroundImages =[bg1,bg2,bg3]
...
<section class="d-flex align-items-center bg-finance" style="background: url('{randomImage}') center;" id="home">
