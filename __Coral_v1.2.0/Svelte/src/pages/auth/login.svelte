...
<section class="bg-home d-flex align-items-center" style="background: url({bg}) center;">
        ...
        <div class="row justify-content-end">
            <div class="col-lg-4 col-md-6 col-12">
                <div class="p-4 bg-white rounded shadow-md mx-auto w-100" style="max-width: 400px;">
                    <form>
                        <Link to="/"><img src={logo} class="mb-4 d-block mx-auto" alt=""></Link>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <span class="forgot-pass text-muted small mb-0"><Link to="/reset-password" class="text-muted">Forgot password ?</Link></span>
                        </div>
        
                        <button class="btn btn-primary w-100" type="submit">Sign in</button>

                        <div class="col-12 text-center mt-3">
                            <span><span class="text-muted me-2 small">Don't have an account ?</span> <Link to="/signup" class="text-dark fw-semibold small">Sign Up</Link></span>
                        </div>
                    </form>
                </div>
            </div>
