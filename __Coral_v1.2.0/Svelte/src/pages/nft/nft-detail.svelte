<script>
    import NftNavdark from "../../components/navbar/nft-navdark.svelte";
    import image from '../../assets/images/nft/1.jpg'
        ...
        <div class="row g-4">
            <div class="col-lg-5 col-md-6">
                <div class="sticky-bar">
                    <img src={data && data.image ? data.image : image} class="img-fluid rounded shadow" alt="">
                </div>
            </div>
            ...
            <div class="col-lg-7 col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-4">
                        <Link to="/nft-detail" class="btn btn-sm btn-primary me-1"><i data-feather="shopping-cart" class="fea icon-sm align-middle me-1"></i> Buy Now</Link>
                        <Link to="/nft-detail" class="btn btn-sm btn-primary"><i data-feather="zap" class="fea icon-sm align-middle me-1"></i> Bid Now</Link>
                    </div>
                </div>
                ...
                <div class="creators creator-primary d-flex align-items-center">
                    <div class="position-relative">
                        <img src={data && data.client ? data.client : team} class="avatar avatar-md-sm shadow-md rounded-pill" alt="">
                    </div>

                    <div class="ms-3">
                        <h6 class="mb-0"><Link to="/creators" class="text-dark name">@StreetBoy</Link></h6>
                    </div>
                </div>
            </div>
        </div>
