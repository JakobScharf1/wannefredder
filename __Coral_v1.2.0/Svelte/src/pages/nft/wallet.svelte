                    ...
                    <div class="wallet position-relative overflow-hidden rounded shadow">
                        ...
                        <div class="position-relative">
                            ...
                            <div class="content text-center p-4">
                                ...
                                <p class="text-muted mt-3 mb-0">Learn about how to get the wallet and much more clicking <a href="#!" class="text-primary">here <i class="mdi mdi-arrow-right"></i></a></p>
                            </div>
                        </div>
                    </div>
                </div>
