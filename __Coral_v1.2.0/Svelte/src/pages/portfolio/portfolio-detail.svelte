<script>
    ...
    import bg1 from '../../assets/images/portfolio/1.jpg'
    import bg2 from '../../assets/images/portfolio/2.jpg'
    import bg3 from '../../assets/images/portfolio/3.jpg'
            ...
            <div class="col-lg-8 col-md-6">
                <div class="tiny-single-item">
                    <div class="tiny-slide">
                        <img src={bg1} class="img-fluid rounded shadow" alt="">
                    </div>
                    
                    <div class="tiny-slide">
                        <img src={bg2} class="img-fluid rounded shadow" alt="">
                    </div>
                    
                    <div class="tiny-slide">
                        <img src={bg3} class="img-fluid rounded shadow" alt="">
                    </div>
                </div>
