                            ...
                            <div class="blog position-relative overflow-hidden shadow rounded p-4">
                                <div class="position-relative">
                                    ...
                                    <div class="position-absolute top-100 start-0 translate-middle-y ms-2">
                                        <a href="#!" class="badge bg-primary">{item.tag}</a>
                                    </div>
                                </div>
            
                                <div class="pt-4">
                                    <Link to="{`/blog-standard-post/${item.id}`}" class="text-dark title h5">{item.title}</Link>
            
                                    <p class="text-muted my-2">{item.desc}</p>
            
                                    <Link to="{`/blog-standard-post/${item.id}`}" class="text-dark read-more">Read More <i class="mdi mdi-chevron-right align-middle"></i></Link>
                                </div>
                            </div>
                        </div>
                    {/each}
