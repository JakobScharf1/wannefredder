<!-- resources/views/index-minimal-portfolio.blade.php -->
@extends('layouts.main')

@section('title', 'Index-Minimal-Portfolio Page')
                ...
                <div class="row align-items-center g-4">
                    ...
                    <div class="col-lg-5 col-md-6 order-1 order-md-2">
                        <div class="position-relative">
                            <img src="{{ asset('assets/images/logo-icon.png') }}" class="img-fluid opacity-25" alt="">
        ...
        <section class="section pt-1">
            <div class="container">
                <div class="row g-0" id="grid">
                    ...
                    <!-- includes/Home/index-minimal-portfolio/portfolio2.blade.php -->
			        @include('includes.Home.index-minimal-portfolio.portfolio2')
