<!-- resources/views/index-finance.blade.php -->
@extends('layouts.main')

@section('title', 'Index-Finance Page')
...
<section class="bg-white py-5 border-top border-bottom">
    <div class="container">
        <div class="row align-items-center g-4">
            ...
            <!-- includes/Home/index-finance/features.blade.php -->
			@include('includes.Home.index-finance.features')
...
<section class="section">
        ...
        <div class="row align-items-center g-4">
            <div class="col-lg-5 col-md-6">
                <div class="rounded shadow bg-soft-primary p-4 pb-0">
                    <img src="{{ asset('assets/images/1.jpg') }}" class="img-fluid rounded-top shadow" alt="">
                </div>
            </div><!--end col-->
            ...
            <div class="col-lg-7 col-md-6">
                <div class="section-title ms-lg-5">
                    ...
                    <div class="mt-4">
                        <a href="{{ url('/aboutus') }}" class="btn btn-soft-primary">About Us <i class="mdi mdi-arrow-right align-middle"></i></a>
                    </div>
                </div>
            </div><!--end col-->
        </div><!--end row-->
    ...
    <div class="container mt-100 mt-60">
        <div class="row align-items-center g-4">
            <div class="col-lg-5 col-md-6 order-1 order-md-2">
                <div class="rounded shadow bg-soft-primary p-4 pb-0">
                    <img src="{{ asset('assets/images/2.jpg') }}" class="img-fluid rounded-top shadow" alt="">
                </div>
            </div><!--end col-->
    ...
    <div class="container mt-100 mt-60">
        <div class="row align-items-center g-4">
            <div class="col-lg-5 col-md-6">
                <div class="rounded shadow bg-soft-primary p-4 pb-0">
                    <img src="{{ asset('assets/images/3.jpg') }}" class="img-fluid rounded-top shadow" alt="">
                </div>
            </div><!--end col-->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            easy_background("#home",
                {
                    slide: ["{{ asset('assets/images/hero/bg1.jpg') }}", "{{ asset('assets/images/hero/bg2.jpg') }}", "{{ asset('assets/images/hero/bg3.jpg') }}"],
