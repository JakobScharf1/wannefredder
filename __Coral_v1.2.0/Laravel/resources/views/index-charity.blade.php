...
<section class="section">
                ...
                <div class="row align-items-center g-4">
                    <div class="col-lg-6 col-md-12">
                        <div class="position-relative">
                            <div class="me-4">
                                <img src="{{ asset('assets/images/about/charity1.jpg') }}" class="img-fluid rounded shadow" alt="">
                            </div>
                            
                            <div class="position-absolute end-0 top-50">
                                <div class="position-relative overflow-hidden rounded shadow">
                                    <img src="{{ asset('assets/images/about/charity2.jpg') }}" class="img-fluid avatar avatar-xl-large" alt="">
    ...
    <div class="container mt-100 mt-60">
        ...
        <div class="row g-4">
            ...
            <!-- includes/Home/index-charity/causes.blade.php -->
			@include('includes.Home.index-charity.causes')
...
<section class="section">
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <!-- includes/Home/index-charity/services9.blade.php -->
			@include('includes.Home.index-charity.services9')
    ...
    <div class="container mt-100 mt-60">
        ...
        <div class="row align-items-center g-4">
            ...
            <!-- includes/Home/index-charity/volunteers.blade.php -->
			@include('includes.Home.index-charity.volunteers')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            easy_background("#home",
                {
                    slide: ["{{ asset('assets/images/hero/charity1.jpg') }}", "{{ asset('assets/images/hero/charity2.jpg') }}", "{{ asset('assets/images/hero/charity3.jpg') }}"],
