        ...
        <div class="row g-4">
            <div class="col-lg-8 col-md-7">
                <div class="row g-4">
                    ...
                    <!-- includes/Blogs/blog-sidebar/blog3.blade.php -->
		            @include('includes.Blogs.blog-sidebar.blog3')
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        ...
                        <!-- includes/Pages/NFT/nft-explore/pagination.blade.php -->
		                @include('includes.Pages.NFT.nft-explore.pagination')
