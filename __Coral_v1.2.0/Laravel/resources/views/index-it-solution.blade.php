...
<!-- Hero Start -->
<section class="bg-half-120 pb-0 d-table w-100 bg-it" style="background: url('{{ asset('assets/images/hero/bg-it.png') }}') center center;">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-6">
                <div class="title-heading mb-5">
                    ...
                    <div class="mt-4">
                        <a href="{{ url('/services') }}" class="btn btn-primary m-1">Get Started <i class="mdi mdi-arrow-right"></i></a>
...
<section class="section">
            ...
            <div class="col-lg-12">
                <div class="features-absolute">
                    <div class="row align-items-center g-4">
                        ...
                        <!-- includes/Home/index-it-solution/services5.blade.php -->
			            @include('includes.Home.index-it-solution.services5')
    ...
    <div class="container mt-100 mt-60">
        ...
        <!-- includes/Home/index-it-solution/about2.blade.php -->
		@include('includes.Home.index-it-solution.about2')
