...
@section('title', 'Portfolio-Detail Page')
                ...
                @if (!empty($item['img']))
                    <div class="tiny-single-item">
                        <div class="tiny-slide">
                            <img src="{{ asset($item['img']) }}" class="img-fluid" alt="Article Image">
                        </div>
                    </div>
                @else
                    <div class="tiny-single-item">
                        <div class="tiny-slide">
                            <img src="{{ asset('assets/images/portfolio/1.jpg') }}" class="img-fluid rounded shadow" alt="">
                        </div>
                        
                        <div class="tiny-slide">
                            <img src="{{ asset('assets/images/portfolio/2.jpg') }}" class="img-fluid rounded shadow" alt="">
                        </div>
                        
                        <div class="tiny-slide">
                            <img src="{{ asset('assets/images/portfolio/3.jpg') }}" class="img-fluid rounded shadow" alt="">
                        </div>
                    </div>
                @endif
