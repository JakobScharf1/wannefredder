...
<!-- Hero Start -->
<section class="bg-hero d-table w-100 bg-dark overflow-hidden" style="background: url('{{ asset('assets/images/hero/bg.png') }}') center center;">
                ...
                <div class="tilt-3d margin-absolute">
                    <div class="tilt-3d-trigger">
                        ...
                        <div class="tilt-3d-image position-relative">
                            <img src="{{ asset('assets/images/hero/hero.png') }}" class="img-fluid rounded-4 border-primary" alt="">
                        </div>
                    </div>
                </div>
            </div><!--end col-->
...
<section class="section overflow-hidden">
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <!-- includes/Home/index-saas/services2.blade.php -->
			@include('includes.Home.index-saas.services2')
    ...
    <div class="container mt-100 mt-60">
        ...
        <!-- includes/Home/index-saas/boost.blade.php -->
		@include('includes.Home.index-saas.boost')

    </div><!--end container-->

    <div class="container mt-100 mt-60">

        <!-- includes/Home/index-saas/optimize.blade.php -->
		@include('includes.Home.index-saas.optimize')
