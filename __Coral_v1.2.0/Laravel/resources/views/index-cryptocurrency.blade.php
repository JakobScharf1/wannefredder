<!-- resources/views/index-cryptocurrency.blade.php -->
@extends('layouts.main')

@section('title', 'Index-Cryptocurrency Page')
...
<!-- Hero Start -->
<section class="bg-half-260 position-relative overflow-hidden pb-5" style="background: url('{{ asset('assets/images/hero/bg-crypto.jpg') }}') top no-repeat;">
    ...
    <div class="container position-relative">
        <div class="row justify-content-center">
            <div class="col-lg-12 text-center">
                <div class="title-heading position-relative z-1 margin-top-100">
                    ...
                    <div class="mt-4 pt-2">
                        <a href="{{ url('/services') }}" class="btn btn-lg btn-pills btn-primary m-1">Join Now</a>
        ...
        <div class="position-absolute top-0 end-0 translate-middle-y">
            <img src="{{ asset('assets/images/bitcoin.png') }}" class="avatar avatar-large mover" alt="">
        </div>

        <div class="position-absolute bottom-0 start-0">
            <img src="{{ asset('assets/images/ethereum.png') }}" class="avatar avatar-large mover" alt="">
        </div>
    </div><!--end container-->
        ...
        <div class="row">
            <div class="col-12">
                <div class="tiny-three-item-icon">
                    ...
                    <!-- includes/Home/index-cryptocurrency/coin-slider.blade.php -->
			        @include('includes.Home.index-cryptocurrency.coin-slider')
...
<section class="section">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-5 col-md-6">
                <img src="{{ asset('assets/images/bitcoin.svg') }}" class="img-fluid" alt="">
            </div><!--end col-->
                ...
                <div class="table-responsive shadow rounded">
                    <table class="table mb-0 table-center bg-white">
                        ...
                        <tbody>
                            ...
                            <!-- includes/Home/index-cryptocurrency/table.blade.php -->
			                @include('includes.Home.index-cryptocurrency.table')
    ...
    <div class="container mt-100 mt-60">
        ...
        <div class="row justify-content-center g-4">
            ...
            <!-- includes/Home/index-cryptocurrency/trader.blade.php -->
			@include('includes.Home.index-cryptocurrency.trader')
        ...
        <div class="row">
            <div class="col-12 mt-4">
                <div class="tiny-three-item">
                    ...
                    <!-- includes/Home/index-saas/review2.blade.php -->
		            @include('includes.Home.index-saas.review2')
    ...
    <div class="container mt-100 mt-60">
        <div class="row align-items-center">
            <div class="col-lg-5 col-md-5 col-12">
                <img src="{{ asset('assets/images/01.png') }}" class="img-fluid mx-auto d-block" alt="">
            </div><!--end col-->
                ...
                <div class="section-title">
                    ...
                    <div class="my-4">
                        <a href="javascript:void(0)">
                            <img src="{{ asset('assets/images/app.png') }}" class="me-2" height="50" alt="">
                        </a>

                        <a href="javascript:void(0)">
                            <img src="{{ asset('assets/images/playstore.png') }}" height="50" alt="">
                        </a>
                    </div>
