        ...
        <div class="position-middle-bottom">
            <nav aria-label="breadcrumb" class="d-block">
                <ul class="breadcrumb breadcrumb-muted mb-0 p-0">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void()">Masonry</a></li>
...
<section class="section">
    <div class="container-fluid">
        <div class="row row-cols-lg-5 row-cols-md-3 row-cols-1 g-4" id="grid">
            
            <!-- includes/Portfolio/Masonry/masonry-five.blade.php -->
		    @include('includes.Portfolio.Masonry.masonry-five')
