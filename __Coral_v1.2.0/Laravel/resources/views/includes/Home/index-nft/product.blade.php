            ...
            <div class="position-relative">
                <div class="nft-image position-relative overflow-hidden rounded shadow">
                    ...
                    <div class="bid-button position-absolute bottom-0 start-0 end-0 text-center pb-3">
                        <a href="{{ route('nft-detail', ['title' => Str::slug($item['title'])]) }}" class="btn btn-sm btn-icon btn-pills btn-primary me-1" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Buy Now"><i data-feather="shopping-cart" class="fea icon-sm align-middle"></i></a>
                        <a href="{{ route('nft-detail', ['title' => Str::slug($item['title'])]) }}" class="btn btn-sm btn-icon btn-pills btn-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Bid Now"><i data-feather="zap" class="fea icon-sm align-middle"></i></a>
                    </div>
                </div>
