...
<tr>
    ...
    <td>
        <div class="d-flex mb-3">
            <img src="{{ asset('assets/images/team/01.jpg') }}" class="avatar avatar-md-sm rounded-circle border shadow" alt="">
            <div class="ms-3">
    ...
    <td>
        <div class="d-flex mb-3">
            <img src="{{ asset('assets/images/team/03.jpg') }}" class="avatar avatar-md-sm rounded-circle border shadow" alt="">
            <div class="ms-3">
...
<tr>
    ...
    <td>
        <div class="d-flex mb-3">
            <img src="{{ asset('assets/images/team/02.jpg') }}" class="avatar avatar-md-sm rounded-circle border shadow" alt="">
            <div class="ms-3">
    ...
    <td>
        <div class="d-flex mb-3">
            <img src="{{ asset('assets/images/team/05.jpg') }}" class="avatar avatar-md-sm rounded-circle border shadow" alt="">
            <div class="ms-3">
    ...
    <td>
        <div class="d-flex mb-3">
            <img src="{{ asset('assets/images/team/04.jpg') }}" class="avatar avatar-md-sm rounded-circle border shadow" alt="">
            <div class="ms-3">
...
<tr>
    ...
    <td>
        <div class="d-flex mb-3">
            <img src="{{ asset('assets/images/team/06.jpg') }}" class="avatar avatar-md-sm rounded-circle border shadow" alt="">
            <div class="ms-3">
