    ...
    <div class="col">
        <div class="position-relative features fea-medical text-center rounded shadow p-4">
            <div class="position-relative d-flex justify-content-center">
                <img src="{{ asset($item['img']) }}" class="avatar avatar-md-sm z-1" alt="">
            ...
            <div class="mt-4">
                ...
                <a href="{{ route('service-detail', ['title' => Str::slug($item['title'])]) }}" class="text-primary">Read More <i class="mdi mdi-arrow-right align-middle"></i></a>
            </div>
        </div>
    </div>
@endforeach