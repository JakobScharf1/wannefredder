                            ...
                            <form>
                                <div className="row">
                                    <div className="col-lg-12">
                                        <div className="mb-3">
                                            <label className="form-label fw-semibold" htmlFor='name'>Patient Name <span className="text-danger">*</span></label>
                                    ...
                                    <div className="col-lg-6">
                                        <div className="mb-3">
                                            <label className="form-label fw-semibold" htmlFor='select'>Departments</label>
                                    ...
                                    <div className="col-lg-6">
                                        <div className="mb-3">
                                            <label className="form-label fw-semibold" htmlFor='select'>Doctor</label>
                                            <select className="form-select form-control">
                                    ...
                                    <div className="col-lg-6">
                                        <div className="mb-3">
                                            <label className="form-label fw-semibold" htmlFor='email'>Your Email <span className="text-danger">*</span></label>
                                    ...
                                    <div className="col-lg-6">
                                        <div className="mb-3">
                                            <label className="form-label fw-semibold" htmlFor='phone'>Your Phone <span className="text-danger">*</span></label>
                                    ...
                                    <div className="col-lg-6">
                                        <div className="mb-3">
                                            <label className="form-label fw-semibold" htmlFor='date'> Date <span className="text-danger">*</span></label>
                                    ...
                                    <div className="col-lg-12">
                                        <div className="mb-3">
                                            <label className="form-label fw-semibold" htmlFor='comments'>Comments <span className="text-danger">*</span></label>
