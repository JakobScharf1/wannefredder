                ...
                <div className="row mt-5 justify-content-center">
                    <div className="col-12">
                        <div className="title-heading text-center">
                            ...
                            <h5 className="heading fw-semibold mb-0 sub-heading text-white title-dark mt-4">A relaxing autumn afternoon from home</h5>
                ...
                <div className="position-middle-bottom">
                    <nav aria-label="breadcrumb" className="d-block">
                        <ul className="breadcrumb breadcrumb-muted mb-0 p-0">
                            ...
                            <li className="breadcrumb-item active" aria-current="page">A relaxing autumn afternoon from home</li>
                        </ul>
                    </nav>
                </div>
            </div>
                    ...
                    <div className="col-lg-8 col-md-7">
                        <div className="card border-0 shadow rounded overflow-hidden">
                            <div className="card-body">
                                <iframe src="https://player.vimeo.com/video/99025203" allow="autoplay; encrypted-media" title='vimeo' style={{height: '433px', width: '100%'}} className="rounded shadow mb-4" allowFullScreen=""></iframe>
                                <BlogDesc/>
                            </div>
                        </div>
