                                        ...
                                        <form>
                                            <div className="row">
                                                <div className="col-12 mb-4">
                                                    <label className="form-label fw-semibold" htmlFor='name'>Art Title <span className="text-danger">*</span></label>
                                                    <input name="name" id="name" type="text" className="form-control" placeholder="Title :"/>
                                                </div>
                                                

                                                <div className="col-12 mb-4">
                                                    <label className="form-label fw-semibold" htmlFor='comments'> Description : </label>
                                                    <textarea name="comments" id="comments" rows="4" className="form-control" placeholder="Description :"></textarea>
                                                </div>
                                                
        
                                                <div className="col-md-6 mb-4">
                                                    <label className="form-label fw-semibold" htmlFor='select'>Type :</label>
                                                ...
                                                <div className="col-md-6 mb-4">
                                                    <label className="form-label fw-semibold" htmlFor='time'> Rate : </label>
                                                ...
                                                <div className="col-md-6 mb-4">
                                                    <label className="form-label fw-semibold" htmlFor='date'> Starting Date : </label>
                                                    <input name="date" type="text" className="form-control start" placeholder="Select date :"/>
                                                </div>
                                                
                
                                                <div className="col-md-6 mb-4">
                                                    <label className="form-label fw-semibold" htmlFor='date'> Expiration date : </label>
