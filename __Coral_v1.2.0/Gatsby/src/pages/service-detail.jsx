                ...
                <div className="row g-4">
                    <div className="col-lg-8 col-md-7">
                        <div className="card position-relative overflow-hidden">
                            <div className="card-img">
                                <img src={blog} className="img-fluid rounded" alt=""/>
                    ...
                    <div className="col-lg-4 col-md-5 col-12">
                        <div className="sticky-bar">
                            <div>
                                {data.map((item,index)=>( 
                                    <Link to="/service-detail" className="bg-light rounded d-flex justify-content-between text-dark py-3 px-4 mb-2" key={index}>
                            ...
                            <div className="bg-light rounded p-4 mt-2">
                                ...
                                <form className="mt-4">
                                    <div className="row">
                                        <div className="col-12">
                                            <div className="mb-3">
                                                <label className="form-label d-none fw-semibold" htmlFor='name'>Your Name <span className="text-danger">*</span></label>
                                        ...
                                        <div className="col-12">
                                            <div className="mb-3">
                                                <label className="form-label d-none fw-semibold" htmlFor='email'>Your Email <span className="text-danger">*</span></label>
                                        ...
                                        <div className="col-12">
                                            <div className="mb-3">
                                                <label className="form-label d-none fw-semibold" htmlFor='comments'>Comments <span className="text-danger">*</span></label>
