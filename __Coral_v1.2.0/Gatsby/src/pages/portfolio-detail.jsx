...
export default function PortfolioDetail() {
    ...
    useEffect(() => {
        import('tiny-slider-react').then((module) => {
            setTinySlider(() => module.default); 
        });
    }, []);
                    ...
                    <div className="col-lg-8 col-md-6">
                        <div className="tiny-single-item">
                             <TinySlider settings={settings}>
                                ...
                                <div className="tiny-slide">
                                    <img src={bg2} className="img-fluid rounded shadow" alt=""/>
                                </div>
                                
                                <div className="tiny-slide">
                                    <img src={bg3} className="img-fluid rounded shadow" alt=""/>
                                </div>
                            </TinySlider>
                        </div>
