...
export default function ProfileSetting() {
    let [file, setFile] = useState(team);
                ...
                <div className="row mt-5 justify-content-center">
                    <div className="col-12">
                        <div className="title-heading text-center">
                            <h5 className="heading fw-semibold mb-0 sub-heading text-white title-dark">Profile Setting</h5>
                        </div>
                    </div>
                </div>
                ...
                <div className="position-middle-bottom">
                    <nav aria-label="breadcrumb" className="d-block">
                        <ul className="breadcrumb breadcrumb-muted mb-0 p-0">
                            ...
                            <li className="breadcrumb-item"><Link to="/creators">Creators</Link></li>
                            <li className="breadcrumb-item"><Link to="/creator-profile">@StreetBoy</Link></li>
                                    ...
                                    <form className="profile-edit">
                                        <div className="row">
                                            <div className="col-12 mb-4">
                                                <label className="form-label h6" htmlFor='name'>Display Name</label>
                                                <input name="name" id="first" type="text" className="form-control" placeholder="streetboyyy"/>
                                            </div>
        
                                            <div className="col-12 mb-4">
                                                <label className="form-label h6" htmlFor='url'>URL</label>
                                                <div className="form-icon">
                                                    <input name="url" id="Coral-url" type="url" className="form-control" placeholder="https://Coral.exe/streetboyyy"/>
                                                </div>
                                            </div>
            
                                            <div className="col-12 mb-4">
                                                <label className="form-label h6" htmlFor='comments'>Bio</label>
                                            ...
                                            <div className="col-12 mb-4">
                                                <label className="form-label h6" htmlFor='url'>Twitter Account</label>
                                            ...
                                            <div className="col-12 mb-4">
                                                <label className="form-label h6" htmlFor='web-url'>Website</label>
                                                <div className="form-icon">
                                        ...
                                        <div className="row">
                                            <div className="col-12">
                                                <button type="submit" id="submit" name="send" className="btn btn-primary rounded">Update Profile</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div className="p-4">
                                    <div className="d-flex justify-content-between pb-4">
                                        ...
                                        <div className="form-check">
                                            ...
                                            <input className="form-check-input" type="checkbox" id="noti1"/>
                                        </div>
                                    </div>
                                    <div className="d-flex justify-content-between py-4 border-top">
                                        ...
                                        <div className="form-check">
                                            ...
                                            <input className="form-check-input" type="checkbox" defaultChecked id="noti2"/>
                                        </div>
                                    </div>
                                    <div className="d-flex justify-content-between py-4 border-top">
                                        <h6 className="mb-0">When shares my activity</h6>
                                        <div className="form-check">
                                            <input className="form-check-input" type="checkbox" id="noti3"/>
                                    ...
                                    <div className="d-flex justify-content-between py-4 border-top">
                                        ...
                                        <div className="form-check">
                                            <input className="form-check-input" type="checkbox" id="noti4"/>
                            ...
                            <div className="rounded shadow mt-4">
                                ...
                                <div className="p-4">
                                    <div className="d-flex justify-content-between pb-4">
                                        ...
                                        <div className="form-check">
                                            <input className="form-check-input" type="checkbox" id="noti5"/>
                                    ...
                                    <div className="d-flex justify-content-between py-4 border-top">
                                        ...
                                        <div className="form-check">
                                            <input className="form-check-input" type="checkbox" id="noti6"/>
                                    ...
                                    <div className="d-flex justify-content-between py-4 border-top">
                                        ...
                                        <div className="form-check">
                                            <input className="form-check-input" type="checkbox" defaultChecked id="noti7"/>
                                    ...
                                    <div className="d-flex justify-content-between py-4 border-top">
                                        ...
                                        <div className="form-check">
                                            <input className="form-check-input" type="checkbox" defaultChecked id="noti8"/>
