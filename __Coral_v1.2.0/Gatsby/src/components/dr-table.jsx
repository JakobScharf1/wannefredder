                            ...
                            <table className="table table-center table-bordered bg-white mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div className="d-flex mb-3">
                                                <img src={team1} className="avatar avatar-md-sm rounded-circle border shadow" alt=""/>
                                                <div className="ms-3">
                                        ...
                                        <td>
                                            <div className="d-flex mb-3">
                                                <img src={team3} className="avatar avatar-md-sm rounded-circle border shadow" alt=""/>
                                                <div className="ms-3">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div className="d-flex mb-3">
                                                <img src={team2} className="avatar avatar-md-sm rounded-circle border shadow" alt=""/>
                                                <div className="ms-3">
                                        ...
                                        <td>
                                            <div className="d-flex mb-3">
                                                <img src={team5} className="avatar avatar-md-sm rounded-circle border shadow" alt=""/>
                                                <div className="ms-3">
                                        ...
                                        <td>
                                            <div className="d-flex mb-3">
                                                <img src={team4} className="avatar avatar-md-sm rounded-circle border shadow" alt=""/>
                                                <div className="ms-3">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div className="d-flex mb-3">
                                                <img src={team6} className="avatar avatar-md-sm rounded-circle border shadow" alt=""/>
                                                <div className="ms-3">
