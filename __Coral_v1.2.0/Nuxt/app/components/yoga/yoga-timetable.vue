    ...
    <div class="row g-4">
        <div class="col-md-4">
            <ul class="nav nav-pills nav-justified flex-column mb-0 sticky-bar" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <NuxtLink class="nav-link rounded shadow active" id="mondayschedule" data-bs-toggle="pill" to="#monday" role="tab" aria-controls="monday" aria-selected="false">
                ...
                <li class="nav-item mt-2">
                    <NuxtLink class="nav-link rounded shadow" id="tuesdayschedule" data-bs-toggle="pill" to="#tuesday" role="tab" aria-controls="tuesday" aria-selected="false">
                        <div class="text-center py-1">
                ...
                <li class="nav-item mt-2">
                    <NuxtLink class="nav-link rounded shadow" id="wednesdayschedule" data-bs-toggle="pill" to="#wednesday" role="tab" aria-controls="wednesday" aria-selected="false">
                        <div class="text-center py-1">
                ...
                <li class="nav-item mt-2">
                    <NuxtLink class="nav-link rounded shadow" id="thursdayschedule" data-bs-toggle="pill" to="#thursday" role="tab" aria-controls="thursday" aria-selected="false">
                        <div class="text-center py-1">
                ...
                <li class="nav-item mt-2">
                    <NuxtLink class="nav-link rounded shadow" id="fridayschedule" data-bs-toggle="pill" to="#friday" role="tab" aria-controls="friday" aria-selected="false">
                        <div class="text-center py-1">
                ...
                <li class="nav-item mt-2">
                    <NuxtLink class="nav-link rounded shadow" id="saturdayschedule" data-bs-toggle="pill" to="#saturday" role="tab" aria-controls="saturday" aria-selected="false">
                        <div class="text-center py-1">
            ...
            <div class="tab-content" id="pills-tabContent">
                            ...
                            <tbody>
                                <tr v-for="(item, index) in data" :key="index">
                                    ...
                                    <td class="p-4" style="min-width: 300px;">
                                        <div class="d-flex">
                                            <img :src="item.image" class="avatar avatar-md-sm rounded-circle border shadow" alt="">
                                            <div class="ms-3">
                ...
                <div class="tab-pane fade" id="thursday" role="tabpanel" aria-labelledby="thursdayschedule">
                    <div class="table-responsive bg-white shadow rounded">
                        <table class="table mb-0 table-center">
                            <tbody>
                                <tr v-for="(item, index) in data.slice(0,4)" :key="index">
                                    <td class="p-4 fw-medium" style="max-width: 100px;">{{item.time}}</td>
                                    <td class="p-4" style="min-width: 300px;">
                                        <div class="d-flex">
                                            <img :src="item.image" class="avatar avatar-md-sm rounded-circle border shadow" alt="">
                ...
                <div class="tab-pane fade" id="friday" role="tabpanel" aria-labelledby="fridayschedule">
                    <div class="table-responsive bg-white shadow rounded">
                        <table class="table mb-0 table-center">
                            <tbody>
                                <tr v-for="(item, index) in data.slice(0,6)" :key="index">
                                    <td class="p-4 fw-medium" style="max-width: 100px;">{{item.time}}</td>
                                    <td class="p-4" style="min-width: 300px;">
                                        <div class="d-flex">
                                            <img :src="item.image" class="avatar avatar-md-sm rounded-circle border shadow" alt="">
                ...
                <div class="tab-pane fade" id="saturday" role="tabpanel" aria-labelledby="saturdayschedule">
                    <div class="table-responsive bg-white shadow rounded">
                        <table class="table mb-0 table-center">
                            <tbody>
                                <tr v-for="(item, index) in data.slice(0,3)" :key="index">
                                    <td class="p-4 fw-medium" style="max-width: 100px;">{{item.time}}</td>
                                    <td class="p-4" style="min-width: 300px;">
                                        <div class="d-flex">
                                            <img :src="item.image" class="avatar avatar-md-sm rounded-circle border shadow" alt="">
