                    ...
                    <div class="col-md-4">
                        <div class="position-relative features text-center mx-lg-4 px-md-1">
                            ...
                            <div class="mt-4">
                                ...
                                <NuxtLink to="tel:+152534-468-854" class="text-primary">+152 534-468-854</NuxtLink>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 mt-5 pt-2 mt-md-0 pt-md-0">
                        <div class="position-relative features text-center mx-lg-4 px-md-1">
                            ...
                            <div class="mt-4">
                                ...
                                <p class="text-muted">Start working with Coral that can provide everything</p>
                                <NuxtLink to="mailto:contact@example.com" class="text-primary">contact@example.com</NuxtLink>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 mt-5 pt-2 mt-md-0 pt-md-0">
                        <div class="position-relative features text-center mx-lg-4 px-md-1">
                            ...
                            <div class="mt-4">
                                ...
                                <NuxtLink to="" class="text-primary">View on Google map</NuxtLink>
                            </div>
                        </div>
                    </div>
                </div>
