                ...
                <div class="row align-items-center mt-5">
                    <div class="col-lg-7 col-md-8 order-md-1 order-2">
                        <div class="title-heading">
                            ...
                            <div class="mt-4 pt-2">
                                <NuxtLink to="#" class="btn btn-primary me-1">Enroll Today</NuxtLink>
                                <NuxtLink to="#" class="btn btn-soft-primary">Make a Donation</NuxtLink>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-4 order-md-2 order-1">
                        <div class="d-md-flex justify-content-center">
                            <NuxtLink href="#!" data-bs-toggle="modal" data-bs-target="#staticBackdrop" class="avatar avatar-md-md rounded-pill shadow bg-white d-flex justify-content-center align-items-center lightbox">
                        ...
                        <div class="row align-items-center g-4">
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="section-title">
                                    ...
                                    <div class="mt-4">
                                        <NuxtLink to="#" class="btn btn-primary">Read More <i class="mdi mdi-arrow-right"></i></NuxtLink>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="position-relative rounded bg-white shadow overflow-hidden">
                            <div class="position-relative overflow-hidden">
                                ...
                                <div class="position-absolute bottom-0 p-4">
                                    <NuxtLink to="#" class="text-white title-dark fw-semibold link-title">Donate Now <i class="mdi mdi-arrow-right"></i></NuxtLink>
                                </div>
                            </div>

                            <div class="content p-4">
                                <h5><NuxtLink to="#" class="text-dark link-title">{{item.title}}</NuxtLink></h5>
