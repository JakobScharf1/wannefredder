<template>
    <div id="boxed-layput" :style="{backgroundImage:`url(${bg})`}">
        <div class="boxed">
                    ...
                    <div class="row align-items-center g-4">
                        ...
                        <div class="col-lg-5 col-md-6 order-1 order-md-2">
                            <div class="position-relative">
                                <img :src="logo" class="img-fluid opacity-25" alt="">
                                <div class="position-absolute top-50 start-50 translate-middle">
                                    <NuxtLink to="#!" data-bs-toggle="modal" data-bs-target="#staticBackdrop" class="avatar avatar-md-md rounded-pill shadow bg-primary d-flex justify-content-center align-items-center lightbox">
            ...
            <section class="section pt-1">
                <div class="container">
                    <div class="column-4 gap-0" id="grid">
                        <div v-for="(item, index) in masonaryData" :key="index" class="">
                            <div class="portfolio masonry position-relative overflow-hidden">
                                ...
                                <div class="content">
                                    <div class="title-body p-3 position-absolute start-0 end-0 m-4">
                                        <NuxtLink to="#" class="link-title text-white fs-5 fw-medium">Artboard Studio</NuxtLink>
                                        <p class="text-white-50 mb-0">Custom Branding</p>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mt-4 text-center">
                                <NuxtLink to="#" class="btn btn-primary">See more works <i class="mdi mdi-arrow-right"></i></NuxtLink>
                            </div>
                        </div>
                    </div>
                </div>
