                ...
                <div class="row g-4">
                    <div class="col-lg-8 col-md-7">
                        <div class="card position-relative overflow-hidden">
                            ...
                            <div class="content p-4 position-absolute bottom-0 start-0">
                                <NuxtLink to="/blog-detail" class="h5 title d-block mb-0 text-white title-dark">Branding Strategy</NuxtLink>
                        ...
                        <ul class="list-unstyled mt-3 mb-0">
                            <li class="mt-2"><NuxtLink to="#" class="text-muted"><i class="mdi mdi-arrow-right text-primary me-2"></i>Deciding to purchase</NuxtLink></li>
                            <li class="mt-2"><NuxtLink to="#" class="text-muted"><i class="mdi mdi-arrow-right text-primary me-2"></i>List your space</NuxtLink></li>
                            <li class="mt-2"><NuxtLink to="#" class="text-muted"><i class="mdi mdi-arrow-right text-primary me-2"></i>Landing an experience or adventure</NuxtLink></li>
                            <li class="mt-2"><NuxtLink to="#" class="text-muted"><i class="mdi mdi-arrow-right text-primary me-2"></i>Top uses questions</NuxtLink></li>
                        </ul>
                    ...
                    <div class="col-lg-4 col-md-5 col-12">
                        <div class="sticky-bar">
                            <div>
                                <NuxtLink v-for="(item, index) in data" :key="index" to="/service-detail" class="bg-light rounded d-flex justify-content-between text-dark py-3 px-4 mb-2">
