            ...
            <div class="row justify-content-end">
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="p-4 bg-white rounded shadow-md mx-auto w-100" style="max-width: 400px;">
                        <form>
                            <NuxtLink to="/"><img :src="logo" class="mb-4 d-block mx-auto" alt=""></NuxtLink>
                            ...
                            <div class="form-check mb-3">
                                ...
                                <label class="form-label form-check-label text-muted" for="flexCheckDefault">I Accept <NuxtLink to="#" class="text-primary">Terms And Condition</NuxtLink></label>
                            </div>
            
                            <button class="btn btn-primary w-100" type="submit">Register</button>

                            <div class="col-12 text-center mt-3">
                                <span><span class="text-muted small me-2">Already have an account ? </span> <NuxtLink to="/login" class="text-dark fw-semibold small">Sign in</NuxtLink></span>
                            </div>
                        </form>
                    </div>
                </div>
