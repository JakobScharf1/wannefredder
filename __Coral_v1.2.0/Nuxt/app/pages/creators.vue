<template>
    <div>
        ...
        <section class="section">
            <div class="container">
                <div class="row g-4">
                    <div v-for="(item, index) in creator" :key="index" class="col-lg-3 col-md-4 col-sm-2 col-12">
                        <div class="position-relative rounded shadow overflow-hidden">
                            ...
                            <div class="position-relative">
                                ...
                                <div class="content text-center p-4">
                                    <div class="mt-4">
                                        <NuxtLink to="/creator-profile" class="text-dark h6 link-title mb-0">{{item.name}}</NuxtLink>
                                    </div>
                                    <small class="text-muted">{{item.title}}</small>

                                    <div class="mt-3">
                                        <NuxtLink to="#" class="btn btn-sm btn-soft-primary">Follow</NuxtLink>
                                    </div>
                                </div>
                            </div>
                        </div>
