                ...
                <div class="row">
                    <div class="col-md-6 background">
                        <div class="title-heading pe-lg-5 pe-md-4">
                            ...
                            <div>
                                <NuxtLink to="#" class="btn btn-primary me-1 mt-4">Get Started <i class="mdi mdi-arrow-right"></i></NuxtLink>
                                <NuxtLink to="#" class="btn btn-outline-primary mt-4">Learn More</NuxtLink>
                            </div>
                ...
                <div class="row align-items-center g-4">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="section-title ms-lg-5">
                            ...
                            <div class="mt-4">
                                <NuxtLink to="/aboutus" class="btn btn-soft-primary">About Us <i class="mdi mdi-arrow-right align-middle"></i></NuxtLink>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="section-title mb-md-0 mb-0 ms-lg-3">
                            ...
                            <div class="mt-3 d-none d-md-block">
                                <NuxtLink to="#" class="btn btn-soft-primary">Contact Now <i class="mdi mdi-arrow-right"></i></NuxtLink>
                            </div>
                        </div>
                    </div>
