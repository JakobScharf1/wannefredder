        ...
        <div class="row g-4">
            <div class="col-lg-8 col-md-7">
                <div class="card position-relative overflow-hidden">
                    <div class="card-img">
                        <img src="<?= base_url('assets/images/blog/8.jpg') ?>" class="img-fluid rounded" alt="">
            ...
            <div class="col-lg-4 col-md-5 col-12">
                <div class="sticky-bar">
                    <div>
                        ...
                        <!-- app/Views/partials/Pages/service-detail/services10.php -->
                        <?= view('partials/Pages/service-detail/services10'); ?>
