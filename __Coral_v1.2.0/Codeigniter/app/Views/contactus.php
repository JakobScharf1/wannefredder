...
<section class="section pb-0">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
                <img src="<?= base_url('assets/images/contact.png') ?>" class="img-fluid d-block mx-auto" alt="">
            </div>
            <div class="col-md-6">
    ...
    <div class="container mt-100 mt-60">
        <div class="row">
            ...
            <!-- app/Views/partials/contactus/contacts.php -->
            <?= view('partials/contactus/contacts'); ?>
