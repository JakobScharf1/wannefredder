...
<!-- Start Hero -->
<section class="bg-home d-flex align-items-center" style="background: url('<?= base_url('assets/images/hero/auth.jpg') ?>') center;">
        ...
        <div class="row justify-content-end">
            <div class="col-lg-4 col-md-6 col-12">
                <div class="p-4 bg-white rounded shadow-md mx-auto w-100" style="max-width: 400px;">
                    <form>
                        <a href="<?= base_url('/') ?>"><img src="<?= base_url('assets/images/logo-dark.png') ?>" class="mb-4 d-block mx-auto" alt=""></a>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <span class="forgot-pass text-muted small mb-0"><a href="<?= base_url('/reset-password') ?>" class="text-muted">Forgot password ?</a></span>
                        </div>
        
                        <button class="btn btn-primary w-100" type="submit">Sign in</button>

                        <div class="col-12 text-center mt-3">
                            <span><span class="text-muted me-2 small">Don't have an account ?</span> <a href="<?= base_url('/signup') ?>" class="text-dark fw-semibold small">Sign Up</a></span>
                        </div><!--end col-->
                    </form>
                </div>
            </div><!--end col-->
