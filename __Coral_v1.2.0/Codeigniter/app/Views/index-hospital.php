    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <div class="swiper-slide d-flex align-items-center overflow-hidden">
                <div class="slide-inner slide-bg-image d-flex align-items-center" style="background: center center;" data-background="<?= base_url('assets/images/hero/1.jpg') ?>">
            ...
            <div class="swiper-slide d-flex align-items-center overflow-hidden">
                <div class="slide-inner slide-bg-image d-flex align-items-center" style="background: center center;" data-background="<?= base_url('assets/images/hero/2.jpg') ?>">
                    <div class="bg-overlay"></div>
                    <div class="container">
                        <div class="row justify-content-center mt-5">
                            <div class="col-12">
            ...
            <div class="swiper-slide d-flex align-items-center overflow-hidden">
                <div class="slide-inner slide-bg-image d-flex align-items-center" style="background: center center;" data-background="<?= base_url('assets/images/hero/3.jpg') ?>">
                    <div class="bg-overlay"></div>
                    <div class="container">
                        <div class="row justify-content-center mt-5">
                            <div class="col-12">
...
<section class="section">
            ...
            <div class="col-lg-5 col-md-6 mb-5 mb-md-0 pb-5 pb-md-4">
                <div class="position-relative">
                    <div class="me-lg-5 me-4">
                        <img src="<?= base_url('assets/images/about/hos1.jpg') ?>" class="img-fluid rounded border border-4 shadow" alt="">
                    </div>
                    
                    <div class="position-absolute top-50 end-0">
                        <img src="<?= base_url('assets/images/about/hos2.jpg') ?>" class="img-fluid h-auto rounded border border-4 shadow" width="250px" alt="">
    ...
    <div class="container mt-100 mt-60">
        ...
        <div class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1 g-4 mt-2">
            ...
            <!-- app/Views/partials/Home/index-hospital/services6.php -->
            <?= view('partials/Home/index-hospital/services6'); ?>

        </div><!--end row-->

        <div class="row justify-content-center mt-4">
            <div class="col-12 text-center">
                <a href="<?= base_url('/services') ?>" class="btn btn-link primary fs-6">See More Services <i class="mdi mdi-arrow-right"></i></a>
            </div><!--end col-->
        </div><!--end row-->
    </div><!--end container-->
</section><!--end section-->
                ...
                <div class="table-responsive rounded">
                    <table class="table table-center table-bordered bg-white mb-0">
                        ...
                        <tbody>
                            ...
                            <!-- app/Views/partials/Home/index-hospital/availability.php -->
                            <?= view('partials/Home/index-hospital/availability'); ?>
...
<!-- Start CTA -->
<section class="cta-video-section position-relative" style="background: url('<?= base_url('assets/images/hero/auth.jpg') ?>') center fixed;">
    <div class="bg-overlay"></div>
    <div class="container">
...
<section class="section">
    <div class="container">
        ...
        <div class="row align-items-center g-4">
            ...
            <!-- app/Views/partials/Home/index-hospital/team.php -->
            <?= view('partials/Home/index-hospital/team'); ?>
