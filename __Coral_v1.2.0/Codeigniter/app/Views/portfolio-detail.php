                ...
                <?php if (!empty($article['img'])): ?>
                    <div class="tiny-single-item">
                        <div class="tiny-slide">
                            <img src="<?= base_url(esc($article['img'])) ?>" class="img-fluid" alt="Article Image">
                        </div>
                    </div>
                <?php else: ?>
                    <div class="tiny-single-item">
                        <div class="tiny-slide">
                            <img src="<?= base_url('assets/images/portfolio/1.jpg') ?>" class="img-fluid rounded shadow" alt="">
                        </div>
                        
                        <div class="tiny-slide">
                            <img src="<?= base_url('assets/images/portfolio/2.jpg') ?>" class="img-fluid rounded shadow" alt="">
                        </div>
                        
                        <div class="tiny-slide">
                            <img src="<?= base_url('assets/images/portfolio/3.jpg') ?>" class="img-fluid rounded shadow" alt="">
                        </div>
                    </div>
                <?php endif; ?>
