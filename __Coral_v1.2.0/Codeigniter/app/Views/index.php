...
<!-- Hero Start -->
<section class="bg-home d-flex align-items-center" style="background: url('<?= base_url('assets/images/hero/bg.jpg') ?>') center center;">
    <div class="bg-overlay bg-gradient-overlay"></div>
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-7 col-md-8 order-md-1 order-2">
                <div class="title-heading">
                    <img src="<?= base_url('assets/images/logo-icon-80-white.png') ?>" class="d-md-block d-none" height="56" alt="">
                    ...
                    <div class="mt-4">
                        <a href="<?= base_url('/services') ?>" class="btn btn-primary">Explore Features <i class="mdi mdi-arrow-right"></i></a>
                    </div>

                    <div class="mt-4 d-flex align-items-center">
                        <ul class="list-unstyled mb-0">
                            <li class="list-inline-item"><img src="<?= base_url('assets/images/team/1.jpg') ?>" class="avatar avatar-md-sm rounded-pill shadow img-thumbnail" alt=""></li>
                            <li class="list-inline-item ms-n24"><img src="<?= base_url('assets/images/team/2.jpg') ?>" class="avatar avatar-md-sm rounded-pill shadow img-thumbnail" alt=""></li>
                            <li class="list-inline-item ms-n24"><img src="<?= base_url('assets/images/team/3.jpg') ?>" class="avatar avatar-md-sm rounded-pill shadow img-thumbnail" alt=""></li>
                            <li class="list-inline-item ms-n24"><img src="<?= base_url('assets/images/team/4.jpg') ?>" class="avatar avatar-md-sm rounded-pill shadow img-thumbnail" alt=""></li>
                        </ul>

                        <a href="<?= base_url('/contactus') ?>" class="text-white ms-3 fw-medium">Join Coral Community <i class="mdi mdi-arrow-right"></i></a>
                    </div>
                </div>
            </div><!--end col-->
...
<section class="section overflow-hidden">
    <div class="container">
        <div class="row">
            ...
            <!-- app/Views/partials/Home/index/services.php -->
            <?= view('partials/Home/index/services'); ?>
    ...
    <div class="container mt-100 mt-60">
        ...
        <!-- app/Views/partials/Home/index/about.php -->
        <?= view('partials/Home/index/about'); ?>

    </div><!--end container-->

    <div class="container-fluid position-relative mt-100 mt-60 pt-5">
        <div class="bg-overlay opacity-25" style="background: url('<?= base_url('assets/images/map.png') ?>') center center;"></div>
        <div class="container mt-5">
            ...
            <div class="row">
                ...
                <!-- app/Views/partials/Home/index/counter.php -->
                <?= view('partials/Home/index/counter'); ?>
...
<!-- Start CTA -->
<section class="cta-video-section position-relative" style="background: url('<?= base_url('assets/images/hero/pages.jpg') ?>') center fixed;">
...
<section class="section">
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <!-- app/Views/partials/Home/index/projects.php -->
            <?= view('partials/Home/index/projects'); ?>
    ...
    <div class="container mt-100 mt-60">
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-6 overflow-hidden">
                <div class="position-relative">
                    <img src="<?= base_url('assets/images/report-analysis-5-18.svg') ?>" class="img-fluid" alt="">
                    ...
                    <div class="row">
                        <div class="col-12 mt-4">
                            <div class="tiny-single-item">
                                ...
                                <!-- app/Views/partials/Home/index/review.php -->
                                <?= view('partials/Home/index/review'); ?>
