...
<section class="bg-half-170 d-table w-100">
    <div class="bg-overlay bg-soft-primary" style="background: url('<?= base_url('assets/images/hero/bg-consulting.png') ?>') bottom no-repeat;"></div>
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-7 col-md-6">
                <div class="title-heading">
                    ...
                    <div class="mt-4 pt-2">
                        <a href="<?= base_url('/services') ?>" class="btn btn-primary m-1">Our Services</a>
...
<section class="section">
    <div class="container">
        ...
        <div class="row align-items-center g-4">
            ...
            <!-- app/Views/partials/Home/index-consulting/services3.php -->
            <?= view('partials/Home/index-consulting/services3'); ?>
    ...
    <div class="container mt-100 mt-60 overflow-hidden">
        ...
        <!-- app/Views/partials/Home/index-consulting/digital.php -->
        <?= view('partials/Home/index-consulting/digital'); ?>
