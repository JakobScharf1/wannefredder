    ...
    <div class="col-lg-4 col-md-6">
        <div class="position-relative rounded bg-white shadow overflow-hidden">
            ...
            <div class="content p-4">
                <h5><a href="" class="text-dark link-title"><?= esc($item['title']) ?></a></h5>
                <p class="text-muted mb-0"><?= esc($item['desc']) ?></p>
                <div class="progress-box mt-5">
                    <div class="progress rounded" style="height: 8px;">
                        <div class="progress-bar position-relative bg-primary rounded" style="width:60%;">
                            <div class="progress-value d-block text-dark h6 mb-0"><?= esc($item['raised']) ?></div>
                        </div>
                    </div>
                </div>

                <div class="d-flex align-items-center justify-content-between mt-3">
                    <h6 class="text-muted mb-0"><?= esc($item['price']) ?></h6>
                    <h6 class="text-muted mb-0"><?= esc($item['price2']) ?></h6>
                </div>
            </div>
        </div>
    </div>
