...
<div class="offcanvas offcanvas-end shadow border-0" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header p-4 border-bottom">
        <h5 id="offcanvasRightLabel" class="mb-0">
            <img src="<?= base_url('assets/images/logo-dark.png') ?>" class="light-version" alt="">
            <img src="<?= base_url('assets/images/logo-light.png') ?>" class="dark-version" alt="">
        </h5>
    ...
    <div class="offcanvas-body p-4">
        <div class="row">
            <div class="col-12">
                <img src="<?= base_url('assets/images/contact.png') ?>" class="img-fluid" alt="">
                <form>
