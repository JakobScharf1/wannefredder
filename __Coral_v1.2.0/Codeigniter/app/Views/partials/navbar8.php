    ...
    <div class="container">
        <a class="logo" href="<?= base_url('/') ?>">
            <span class="logo-light-mode">
                <img src="<?= base_url('assets/images/logo-dark.png') ?>" class="l-dark" alt="">
                <img src="<?= base_url('assets/images/logo-white.png') ?>" class="l-light" alt="">
            </span>
        ...
        <ul class="buy-button list-inline mb-0">
            ...
            <li class="list-inline-item ps-1 mb-0">
                <div class="dropdown dropdown-primary">
                    <button type="button" class="btn btn-pills dropdown-toggle p-0" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?= base_url('assets/images/team/1.jpg') ?>" class="rounded-pill avatar avatar-ex-small" alt=""></button>
                    <div class="dropdown-menu dd-menu dropdown-menu-end bg-white shadow border-0 mt-3 pb-3 pt-0 overflow-hidden rounded" style="min-width: 200px;">
                        <div class="position-relative">
                            <div class="p-3">
                                <div class="d-flex align-items-center mt-n4">
                                    <img src="<?= base_url('assets/images/team/1.jpg') ?>" class="rounded-pill avatar avatar-md-sm img-thumbnail shadow-md" alt="">
                        ...
                        <div class="mt-2">
                            <a class="dropdown-item small fw-semibold text-dark d-flex align-items-center" href="<?= base_url('/creator-profile') ?>"><span class="mb-0 d-inline-block me-1"><i data-feather="user" class="fea icon-sm me-1 align-middle"></i></span> Profile</a>
                            <a class="dropdown-item small fw-semibold text-dark d-flex align-items-center" href="<?= base_url('/profile-setting') ?>"><span class="mb-0 d-inline-block me-1"><i data-feather="settings" class="fea icon-sm me-1 align-middle"></i></span> Settings</a>
                            <div class="dropdown-divider border-top"></div>
                            <a class="dropdown-item small fw-semibold text-dark d-flex align-items-center" href="<?= base_url('/lock-screen') ?>"><span class="mb-0 d-inline-block me-1"><i data-feather="log-out" class="fea icon-sm me-1 align-middle"></i></span> Logout</a>
                        </div>
                    </div>
                </div>
            </li>
