                    ...
                    <div className="col-lg-8 col-md-7">
                        <div className="card border-0 shadow rounded overflow-hidden">
                            <div className="card-body">
                                <iframe src="https://www.youtube.com/embed/yba7hPeTSjk?feature=oembed" allow="autoplay; encrypted-media" style={{height: '433px', width: '100%'}} className="rounded shadow mb-4" allowFullScreen=""></iframe>
                                <BlogDesc/>
                            </div>
                        </div>
