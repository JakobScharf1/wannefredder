  ...
  return (
    <>
        <div className="card-body">
            ...
            <blockquote className="text-center mx-auto blockquote"><i className="mdi mdi-format-quote-open mdi-48px text-muted opacity-2 d-block"></i> The man who comes back through the door in the wall will never be quite the same as the man who went out. <small className="d-block text-muted mt-2">- Coral Template</small></blockquote>
            ...
            <Link href="#" className="badge badge-link bg-primary mx-1">Interior</Link>
