                        ...
                        <div className="rounded shadow overflow-hidden sticky-bar">
                            ...
                            <div className="position-relative">
                                <div className="position-absolute top-0 start-50 translate-middle">
                                    <Image src='/images/team/1.jpg' width={65} height={65} className="avatar avatar-small rounded-pill shadow-sm img-thumbnail bg-light" alt=""/>
                                </div>
                                <div className="content text-center p-4">
                                    <div className="mt-4">
                                        ...
                                        <ul className="list-unstyled mb-0 mt-3" id="navmenu-nav">
                                            <li className="px-0">
                                                <Link href="/creator-profile" className="d-flex align-items-center text-dark">
                                            ...
                                            <li className="px-0 mt-2">
                                                <Link href="/profile-setting" className="d-flex align-items-center text-dark">
                                            ...
                                            <li className="px-0 mt-2">
                                                <Link href="/lock-screen" className="d-flex align-items-center text-dark">
                            ...
                            <div className="row">
                                <div className="col-lg-5">
                                    <div className="d-grid">
                                        ...
                                        {file && 
                                            <div className="preview-box d-block justify-content-center rounded shadow overflow-hidden bg-light text-muted p-2 text-center small"><Image src={file} width={0} height={0} sizes='100vw' style={{width:'100%', height:'auto'}} alt=""/></div>
                                        }
                                        {!file && 
