                    ...
                    <div className="col-12 p-0">
                        <div className="d-flex flex-column min-vh-100 justify-content-center px-md-5 py-5 px-4">
                            ...
                            <div className="title-heading text-center my-auto">
                                <Image src='/images/error.png' width={0} height={0} sizes="100vw" style={{width:'400px', height:'auto'}} className="img-fluid" alt=""/>
                            ...
                            <div className="text-center">
                                <p className="mb-0 text-muted">© {new Date().getFullYear()} Coral. Design & Develop with <i className="mdi mdi-heart text-danger"></i> by <Link href="https://shreethemes.in/" target="_blank" className="text-reset">Shreethemes</Link>.</p>
                            </div>
                        </div>
                    </div>
                </div>
