...
import CounterAbout from '../components/counter/counter-about'
                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-7 col-md-6 mt-4 mt-md-0 pt-2 pt-md-0">
                        <div className="section-title ms-lg-5">
                            ...
                            <div className="mt-4">
                                <Link href="#" className="btn btn-link primary fs-6">Start A Project <i className="mdi mdi-arrow-right align-middle"></i></Link>
                            </div>
                        </div>
                    </div>
                </div>
