    ...
    <Navlight/>
                ...
                <div className="position-middle-bottom">
                    <nav aria-label="breadcrumb" className="d-block">
                        <ul className="breadcrumb breadcrumb-muted mb-0 p-0">
                            ...
                            <li className="breadcrumb-item"><Link href="#">Creative</Link></li>
                            <li className="breadcrumb-item active" aria-current="page">Six Columns</li>
                        </ul>
                    </nav>
                </div>
            </div>
        ...
        <section className="section">
            <div className="container-fluid">
                <div className="row row-cols-lg-6 row-cols-md-3 row-cols-1 g-4">
                        ...
                        <div className="col" key={index}>
                            <div className="portfolio creative rounded shadow position-relative overflow-hidden">
                                ...
                                <div className="content position-absolute bottom-0 start-0 end-0 m-4">
                                    <Link href="#" className="text-white fs-5 fw-medium link-title">{item.title}</Link>
