        ...
        <section className="section">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-12">
                                            <div className="form-check">
                                                ...
                                                <label className="form-check-label" htmlFor="flexCheckDefault">I agree to the <Link href="#" className="text-primary">Terms and Conditions</Link>.</label>
                                            </div>
                                        </div>                                    
                        ...
                        <div className="row align-items-center g-4">
                            <div className="col-lg-6 col-md-12">
                                <div className="position-relative">
                                    <div className="me-4">
                                        <Image src='/images/about/charity1.jpg' width={0} height={0} sizes="100vw" style={{width:'100%', height:'auto'}} className="img-fluid rounded shadow" alt=""/>
                                    </div>
                                    
                                    <div className="position-absolute end-0 top-50">
                                        <div className="position-relative overflow-hidden rounded shadow">
                                            <Image src='/images/about/charity2.jpg' width={180} height={180} className="img-fluid avatar avatar-xl-large" alt=""/>
                                            <div className="bg-overlay bg-primary opacity-75"></div>

                                            <div className="position-absolute top-50 start-50 translate-middle">
                                                <div className="counter-box text-center">
                                                    <h2 className="fw-bold mb-0 text-white">100M</h2>
                            ...
                            <div className="col-lg-6 col-md-12">
                                <div className="section-title">
                                    ...
                                    <div className="mt-4">
                                        <Link href="#" className="btn btn-primary">Read More <i className="mdi mdi-arrow-right"></i></Link>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div className="container mt-100 mt-60">
                ...
                <div className="row g-4">
                    {causeData.map((item:CauseData,index:number)=>( 
                            ...
                            <div className="position-relative rounded bg-white shadow overflow-hidden">
                                <div className="position-relative overflow-hidden">
                                    ...
                                    <div className="position-absolute bottom-0 p-4">
                                        <Link href="#" className="text-white title-dark fw-semibold link-title">Donate Now <i className="mdi mdi-arrow-right"></i></Link>
                                    </div>
                                </div>

                                <div className="content p-4">
                                    <h5><Link href="#" className="text-dark link-title">{item.title}</Link></h5>
