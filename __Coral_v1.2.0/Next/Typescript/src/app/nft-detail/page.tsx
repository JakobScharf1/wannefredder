                ...
                <div className="row g-4">
                    <div className="col-lg-5 col-md-6">
                        <div className="sticky-bar">
                            <Image src='/images/nft/1.jpg' width={0} height={0} sizes='100vw' style={{width:'100%', height:'auto'}} className="img-fluid rounded shadow" alt=""/>
                        </div>
                    </div>

                    <div className="col-lg-7 col-md-6">
                        <div className="title-heading">
                            <h4 className="h3 mb-0">Deep Sea Phantasy</h4>
                        </div>
                        ...
                        <div className="creators creator-primary d-flex align-items-center">
                            <div className="position-relative">
                                <Image src='/images/team/1.jpg' width={45} height={45} className="avatar avatar-md-sm shadow-md rounded-pill" alt=""/>
                            </div>
