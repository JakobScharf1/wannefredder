...
export default function IndexSaas() {
  return (
    <>
        ...
        <section className="bg-hero d-table w-100 bg-dark overflow-hidden" style={{backgroundImage:`url('/images/hero/bg.png')`, backgroundPosition:'center'}}>
                        ...
                        <div className="tilt-3d margin-absolute">
                            <div className="tilt-3d-trigger">
                                ...
                                <div className="tilt-3d-image position-relative">
                                    <Image src='/images/hero/hero.png' width={0} height={0} sizes='100vw' style={{width:'100%', height:'auto'}} className="img-fluid rounded-4 border-primary" alt=""/>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="row g-4 align-items-center">
                    <div className="col-lg-6 col-md-6">
                        <div className="position-relative">
                            <Image src='/images/1.png' width={0} height={0} sizes='100vw' style={{width:'100%', height:'auto'}} className="img-fluid rounded-2" alt=""/>
