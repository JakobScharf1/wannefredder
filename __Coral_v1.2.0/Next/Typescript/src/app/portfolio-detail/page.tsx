                        ...
                        <div className="tiny-single-item">
                             <TinySlider settings={settings}>
                                <div className="tiny-slide">
                                    <Image src='/images/portfolio/1.jpg' width={0} height={0} sizes='100vw' style={{width:'100%', height:'auto'}} className="img-fluid rounded shadow" alt=""/>
                                </div>
                                
                                <div className="tiny-slide">
                                    <Image src='/images/portfolio/2.jpg' width={0} height={0} sizes='100vw' style={{width:'100%', height:'auto'}} className="img-fluid rounded shadow" alt=""/>
                                </div>
                                
                                <div className="tiny-slide">
                                    <Image src='/images/portfolio/3.jpg' width={0} height={0} sizes='100vw' style={{width:'100%', height:'auto'}} className="img-fluid rounded shadow" alt=""/>
                                </div>
                            </TinySlider>
                        </div>
