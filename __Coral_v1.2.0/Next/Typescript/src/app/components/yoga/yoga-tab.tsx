            ...
            <div className="col-md-4">
                <ul className="nav nav-pills nav-justified flex-column mb-0 sticky-bar" id="pills-tab" role="tablist">
                    <li className="nav-item">
                        <Link className="nav-link rounded shadow active" id="mondayschedule" data-bs-toggle="pill" href="#monday" role="tab" aria-controls="monday" aria-selected="false">
                    ...
                    <li className="nav-item mt-2">
                        <Link className="nav-link rounded shadow" id="tuesdayschedule" data-bs-toggle="pill" href="#tuesday" role="tab" aria-controls="tuesday" aria-selected="false">
                            <div className="text-center py-1">
                    ...
                    <li className="nav-item mt-2">
                        <Link className="nav-link rounded shadow" id="wednesdayschedule" data-bs-toggle="pill" href="#wednesday" role="tab" aria-controls="wednesday" aria-selected="false">
                            <div className="text-center py-1">
                    ...
                    <li className="nav-item mt-2">
                        <Link className="nav-link rounded shadow" id="thursdayschedule" data-bs-toggle="pill" href="#thursday" role="tab" aria-controls="thursday" aria-selected="false">
                            <div className="text-center py-1">
                    ...
                    <li className="nav-item mt-2">
                        <Link className="nav-link rounded shadow" id="fridayschedule" data-bs-toggle="pill" href="#friday" role="tab" aria-controls="friday" aria-selected="false">
                            <div className="text-center py-1">
                    ...
                    <li className="nav-item mt-2">
                        <Link className="nav-link rounded shadow" id="saturdayschedule" data-bs-toggle="pill" href="#saturday" role="tab" aria-controls="saturday" aria-selected="false">
                            <div className="text-center py-1">
                ...
                <div className="tab-content" id="pills-tabContent">
                    <div className="tab-pane fade show active" id="monday" role="tabpanel" aria-labelledby="mondayschedule">
                        <div className="table-responsive bg-white shadow rounded">
                            <table className="table mb-0 table-center">
                                <tbody>
                                    {data.map((item:yogaData,index:number)=>( 
                                        <tr key={index}>
                    ...
                    <div className="tab-pane fade" id="tuesday" role="tabpanel" aria-labelledby="tuesdayschedule">
                        <div className="table-responsive bg-white shadow rounded">
                            <table className="table mb-0 table-center">
                                <tbody>
                                    {data.slice(0,5).map((item:yogaData,index:number)=>( 
                                        <tr key={index}>
                                            <td className="p-4 fw-medium" style={{maxWidth: '100px'}}>8:00AM</td>
                                            <td className="p-4" style={{minWidth: '300px'}}>
                                                <div className="d-flex">
                    ...
                    <div className="tab-pane fade" id="thursday" role="tabpanel" aria-labelledby="thursdayschedule">
                        <div className="table-responsive bg-white shadow rounded">
                            <table className="table mb-0 table-center">
                                <tbody>
                                    {data.slice(0,4).map((item:yogaData,index:number)=>( 
                                        <tr key={index}>
                                            <td className="p-4 fw-medium" style={{maxWidth: '100px'}}>8:00AM</td>
                                            <td className="p-4" style={{minWidth: '300px'}}>
                                                <div className="d-flex">
                    ...
                    <div className="tab-pane fade" id="friday" role="tabpanel" aria-labelledby="fridayschedule">
                        <div className="table-responsive bg-white shadow rounded">
                            <table className="table mb-0 table-center">
                                <tbody>
                                    {data.slice(0,6).map((item:yogaData,index:number)=>( 
                                        <tr key={index}>
                                            <td className="p-4 fw-medium" style={{maxWidth: '100px'}}>8:00AM</td>
                                            <td className="p-4" style={{minWidth: '300px'}}>
                                                <div className="d-flex">
                    ...
                    <div className="tab-pane fade" id="saturday" role="tabpanel" aria-labelledby="saturdayschedule">
                        <div className="table-responsive bg-white shadow rounded">
                            <table className="table mb-0 table-center">
                                <tbody>
                                    {data.slice(0,3).map((item:yogaData,index:number)=>( 
                                        <tr key={index}>
                                            <td className="p-4 fw-medium" style={{maxWidth: '100px'}}>8:00AM</td>
                                            <td className="p-4" style={{minWidth: '300px'}}>
                                                <div className="d-flex">
