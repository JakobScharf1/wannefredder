...
export default function VideoOne({className}:{className:string}) {
    let [open, setOpen] = useState(false)
  return (
    <>
        <div className={className}>
            <Link href="#!" scroll={false} onClick={() =>setOpen(!open)} className="avatar avatar-md-md rounded-pill shadow bg-white d-flex justify-content-center align-items-center lightbox">
