                ...
                <div className="row mt-5 justify-content-center">
                    <div className="col-12">
                        <div className="title-heading text-center">
                            ...
                            <h5 className="heading fw-semibold mb-0 sub-heading text-white title-dark mt-4">Utilizing mobile technology in the field</h5>
                ...
                <div className="position-middle-bottom">
                    <nav aria-label="breadcrumb" className="d-block">
                        <ul className="breadcrumb breadcrumb-muted mb-0 p-0">
                            ...
                            <li className="breadcrumb-item active" aria-current="page">Utilizing mobile technology in the field</li>
                        </ul>
                    </nav>
                </div>
            </div>
                ...
                <div className="row g-4">
                    <div className="col-lg-8 col-md-7">
                        <div className="card border-0 shadow rounded overflow-hidden">
                            <Image src='/images/blog/1.jpg' width={0} height={0} sizes='100vw' style={{width:'100%', height:'auto'}} className="img-fluid" alt=""/>
                            <BlogDesc/>
                        </div>
