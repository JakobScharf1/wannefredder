...
export default function BlogStandardPost({params}:{params:any}) {
    const { id }:any = use(params)

    let data:any = blogData.find((item)=>item.id === parseInt(id))
  return (
    <>
        <Navlight/>
                ...
                <div className="row mt-5 justify-content-center">
                    <div className="col-12">
                        <div className="title-heading text-center">
                            ...
                            <h5 className="heading fw-semibold mb-0 sub-heading text-white title-dark mt-4">{data && data.title}</h5>
                ...
                <div className="row g-4">
                    <div className="col-lg-8 col-md-7">
                        <div className="card border-0 shadow rounded overflow-hidden">
                            <Image src={data && data.image} width={0} height={0} sizes='100vw' style={{width:'100%', height:'auto'}} className="img-fluid" alt=""/>
                            <BlogDesc/>
                        </div>
