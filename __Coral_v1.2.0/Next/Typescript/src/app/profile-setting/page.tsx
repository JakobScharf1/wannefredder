...
export default function ProfileSetting() {
    let [file, setFile] = useState<string>('/images/team/1.jpg');
                ...
                <div className="position-middle-bottom">
                    <nav aria-label="breadcrumb" className="d-block">
                        <ul className="breadcrumb breadcrumb-muted mb-0 p-0">
                            ...
                            <li className="breadcrumb-item"><Link href="/creators">Creators</Link></li>
                            <li className="breadcrumb-item"><Link href="/creator-profile">@StreetBoy</Link></li>
