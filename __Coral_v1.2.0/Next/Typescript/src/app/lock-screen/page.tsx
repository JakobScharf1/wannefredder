...
export default function LockScreen() {
  return (
    <>
        <section className="bg-home d-flex align-items-center" style={{backgroundImage:`url('/images/hero/auth.jpg')`, backgroundPosition:'center'}}>
                    ...
                    <div className="col-lg-4 col-md-6 col-12">
                        <div className="p-4 bg-white rounded shadow-md mx-auto w-100" style={{maxWidth: '400px'}}>
                            <div className="text-center">
                                <Image src='/images/team/1.jpg' width={80} height={80} className="avatar avatar-md-md rounded-pill mb-3 shadow" alt=""/>
