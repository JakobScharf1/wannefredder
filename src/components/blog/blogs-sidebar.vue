<template>
    <div class="card bg-white p-4 rounded shadow sticky-bar">
        ...
        <div class="mt-4">
            ...
            <div class="mt-4">
                <div v-for="(item, index) in recentPost" :key="index" class="blog blog-primary d-flex align-items-center mt-3">
                    <img :src="item.image" class="avatar avatar-small rounded" style="width: auto;" alt=""/>
                    <div class="flex-1 ms-3">
                        <router-link to="#" class="d-block title text-dark fw-medium">{{item.title}}</router-link>
        ...
        <div class="mt-4 text-center">
            ...
            <ul class="tagcloud list-unstyled mt-4">
                <li v-for="(item, index) in blogTag" :key="index" class="d-inline-flex m-1"><router-link to="#" class="rounded fw-medium text-dark py-1 px-2">{{item}}</router-link></li>
            </ul>
        </div>
    </div>
</template>
