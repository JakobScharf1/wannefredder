                ...
                <div class="position-middle-bottom">
                    <nav aria-label="breadcrumb" class="d-block">
                        <ul class="breadcrumb breadcrumb-muted mb-0 p-0">
                            ...
                            <li class="breadcrumb-item"><router-link to="/creators">Creators</router-link></li>
                            <li class="breadcrumb-item"><router-link to="/creator-profile">@StreetBoy</router-link></li>
                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-5 col-12">
                        <div class="profile-pic">
                            <input id="pro-img" name="profile-image" type="file" class="d-none" @change="handleChange($event)" />
                            <div class="position-relative d-inline-block">
                               <img :src="image" class="avatar avatar-medium img-thumbnail rounded-pill shadow-sm" id="profile-image" alt="">
