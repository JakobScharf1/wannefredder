<template>
    <div>
        ...
        <section class="d-flex align-items-center bg-finance" id="home" :style="{backgroundImage:`url(${randomImage})`}">
                ...
                <div class="row">
                    <div class="col-md-6 background">
                        <div class="title-heading pe-lg-5 pe-md-4">
                            ...
                            <div>
                                <router-link to="#" class="btn btn-primary me-1 mt-4">Get Started <i class="mdi mdi-arrow-right"></i></router-link>
                                <router-link to="#" class="btn btn-outline-primary mt-4">Learn More</router-link>
                            </div>
        ...
        <section class="bg-white py-5 border-top border-bottom">
            <div class="container">
                <div class="row align-items-center g-4">
                    <div v-for="(item, index) in servicesData.slice(0,4)" :key="index" class="col-lg-3 col-md-6">
        ...
        <section class="section">
                ...
                <div class="row align-items-center g-4">
                    <div class="col-lg-5 col-md-6">
                        <div class="rounded shadow bg-soft-primary p-4 pb-0">
                            <img :src="about1" class="img-fluid rounded-top shadow" alt="">
                        </div>
                    </div>
            ...
            <div class="container mt-100 mt-60">
                <div class="row align-items-center g-4">
                    <div class="col-lg-5 col-md-6 order-1 order-md-2">
                        <div class="rounded shadow bg-soft-primary p-4 pb-0">
                            <img :src="about2" class="img-fluid rounded-top shadow" alt="">
                        </div>
                    </div>
            ...
            <div class="container mt-100 mt-60">
                <div class="row align-items-center g-4">
                    <div class="col-lg-5 col-md-6">
                        <div class="rounded shadow bg-soft-primary p-4 pb-0">
                            <img :src="about3" class="img-fluid rounded-top shadow" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="section-title mb-md-0 mb-0 ms-lg-3">
                            ...
                            <div class="mt-3 d-none d-md-block">
                                <router-link to="#" class="btn btn-soft-primary">Contact Now <i class="mdi mdi-arrow-right"></i></router-link>
                            </div>
                        </div>
                    </div>
