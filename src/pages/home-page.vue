<template>
    <div>
        ...
        <section class="bg-half-260" id="home" :style="{backgroundImage:`url(${randomImage})`, backgroundPosition:'center'}">
                ...
                <div class="row align-items-center mt-5">
                    <div class="col-lg-7 col-md-8 order-md-1 order-2">
                        <div class="title-heading">
                            ...
                            <div class="mt-4 pt-2">
                                <router-link to="#" class="btn btn-primary me-1">Enroll Today</router-link>
                                <router-link to="#" class="btn btn-soft-primary">Make a Donation</router-link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-4 order-md-2 order-1">
                        <div class="d-md-flex justify-content-center">
                            <a href="#!" data-bs-toggle="modal" data-bs-target="#staticBackdrop" class="avatar avatar-md-md rounded-pill shadow bg-white d-flex justify-content-center align-items-center lightbox">
        ...
        <section class="section">
                        ...
                        <div class="row align-items-center g-4">
                            <div class="col-lg-6 col-md-12">
                                <div class="position-relative">
                                    <div class="me-4">
                                        <img :src="about1" class="img-fluid rounded shadow" alt="">
                                    </div>
                                    
                                    <div class="position-absolute end-0 top-50">
                                        <div class="position-relative overflow-hidden rounded shadow">
                                            <img :src="about2" class="img-fluid avatar avatar-xl-large" alt="">
                                            <div class="bg-overlay bg-primary opacity-75"></div>

                                            <div class="position-absolute top-50 start-50 translate-middle">
                                                <div class="counter-box text-center">
                                                    <h2 class="fw-bold mb-0 text-white"><span class="counter-value" data-target="100">100</span>M</h2>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="section-title">
                                    ...
                                    <div class="mt-4">
                                        <router-link to="#" class="btn btn-primary">Read More <i class="mdi mdi-arrow-right"></i></router-link>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container mt-100 mt-60">
                ...
                <div class="row g-4">
                    <div v-for="(item, index) in causeData" :key="index" class="col-lg-4 col-md-6">
                        <div class="position-relative rounded bg-white shadow overflow-hidden">
                            <div class="position-relative overflow-hidden">
                                ...
                                <div class="position-absolute bottom-0 p-4">
                                    <router-link to="#" class="text-white title-dark fw-semibold link-title">Donate Now <i class="mdi mdi-arrow-right"></i></router-link>
                                </div>
                            </div>

                            <div class="content p-4">
                                <h5><router-link to="#" class="text-dark link-title">{{item.title}}</router-link></h5>
                                ...
                                <div class="progress-box mt-5">
                                    <div class="progress rounded" style="height: 8px;">
                                        <div class="progress-bar position-relative bg-primary rounded" style="width:60%;">
                                            <div class="progress-value d-block text-dark h6 mb-0">{{item.progress}}</div>
                                        </div>
                                    </div>
                                </div>

                                <div class="d-flex align-items-center justify-content-between mt-3">
                                    <h6 class="text-muted mb-0">{{item.value1}}</h6>
                                    <h6 class="text-muted mb-0">{{item.value2}}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script setup>
    ...
    import bg1 from '@/assets/images/hero/charity1.jpg'
    import bg2 from '@/assets/images/hero/charity2.jpg'
    import bg3 from '@/assets/images/hero/charity3.jpg'
    ...
    const changeBackground = () =>{
        ...
        randomImage.value = backgroundImages.value[randomIndex];
    }
